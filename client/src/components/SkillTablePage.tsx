...
const classPlans: ClassPlan[] = [
  {
    ...
    skills: [
      ...
      },
      {
        ...
        name: '橫掃',
        role: '近戰範圍',
        cost: '消耗 25 怒氣；瞬發；0 CD',
        scope: '戰鬥中怪物',
        tickRule: '瞬發攻擊目前戰鬥中最多 3 隻怪，不消耗 tick，不影響隔壁房。',
  ...
  },
  {
    ...
    tickCore: '專注起手 100/100；攻擊、偵查與陷阱消耗專注，時間流逝、成功閃避與部分命中行為恢復專注。',
    resource: '專注：初始 100，上限 100。戰鬥中每個 tick 自然 +15；非戰鬥中每 10 秒 +15。',
    ...
    skills: [
      ...
      },
      {
        ...
        cost: '消耗 35 專注',
        scope: '本房單體',
        tickRule: '瞬發不佔 tick、無冷卻；命中時 30% 機率暈眩 1 tick。',
        upgrades: ['Lv2 傷害 +8%', 'Lv3 暈眩率 +5%', 'Lv4 消耗 -5 專注', 'Lv5 對標記目標額外傷害'],
      },
      {
        level: 1,
        name: '偵查',
        ...
        cost: '消耗 20 專注',
        scope: '指定方向',
        tickRule: '非攻擊行動；顯示並刷新指定相鄰房怪物現況，可重複偵查同一方向。',
      ...
      },
      {
        ...
        scope: '本房間 / 已偵查相鄰房單體',
        tickRule: '預先標記目標，不造成傷害也不產生 approaching；30 秒內進入戰鬥時生效 4 tick，你對該目標傷害 +15%，命中 +10%。',
        upgrades: ['Lv2 傷害加成提高到 +20%', 'Lv3 隊友獲得半額加成', 'Lv4 射擊標記目標額外回 +5 專注', 'Lv5 標記觸發後延長 1 tick'],
      },
      {
        level: 8,
        name: '伏擊陷阱',
      ...
      },
      {
        ...
        upgrades: ['Lv2 持續 +1 tick', 'Lv3 命中下降提高到 -15%', 'Lv4 對遠程怪額外 -8% 命中', 'Lv5 施放後強襲消耗 -5 專注'],
      },
    ],
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        name: '懺悔',
        role: '轉換',
        cost: '不消耗資源；冷卻 10 tick',
        scope: '自己',
        tickRule: '瞬發不佔 tick；將目前信仰翻轉到另一端，例如 0 變 100、90 變 10。',
        upgrades: ['Lv2 CD -1', 'Lv3 翻轉後短暫抗性', 'Lv4 CD -1', 'Lv5 翻轉後獲得少量護盾'],
      },
      {
        level: 5,
        name: '淨化',
