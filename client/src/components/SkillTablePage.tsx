...
const classPlans: ClassPlan[] = [
  {
    ...
    tickCore: '防禦與嘲諷推動怒氣；越被打越能反擊，並能把 approaching 怪物變成可控壓力。',
    resource: '怒氣：普攻、格擋、被攻擊時累積，用於爆發與大範圍拉怪。',
    ...
    skills: [
      {
        ...
        role: '基礎攻擊',
        scope: '本房間 / 目前戰鬥目標',
        tickRule: '當 tick 結算時攻擊目前目標；命中後獲得少量怒氣。',
        upgrades: ['Lv2 傷害 +8%', 'Lv3 命中後破甲 1 tick', 'Lv4 怒氣獲得 +1', 'Lv5 對被挑釁目標追加傷害'],
      },
      {
        level: 1,
        name: '防禦架勢',
        role: '承傷',
        scope: '自己',
        tickRule: '下一個 tick 受到傷害降低；被命中時獲得怒氣。',
        upgrades: ['Lv2 減傷提高', 'Lv3 抗打斷', 'Lv4 低血量額外減傷', 'Lv5 防禦後下一次斬擊增傷'],
      },
      {
        level: 1,
        name: '挑釁',
        ...
        upgrades: ['Lv2 仇恨提高', 'Lv3 CD -1', 'Lv4 可挑釁同房 2 隻', 'Lv5 抵達怪物首 tick 傷害降低'],
      },
      {
        level: 5,
        name: '橫掃',
        role: '近戰範圍',
        scope: '戰鬥中怪物',
        tickRule: '攻擊目前戰鬥中的多隻怪，不影響隔壁房。',
        upgrades: ['Lv2 目標數 +1', 'Lv3 命中降低敵攻擊 1 tick', 'Lv4 怒氣消耗降低', 'Lv5 對被挑釁目標必定命中'],
      },
      {
        level: 8,
        name: '極限嘲諷',
        role: '四方瞬間拉怪',
        scope: '東西南北相鄰房間',
        tickRule: 'arrivalTicks = 0，四方可移動怪物立刻進入本房並加入戰鬥；自己獲得短暫減傷。',
        upgrades: ['Lv2 減傷提高', 'Lv3 拉怪後獲得護盾', 'Lv4 CD -1', 'Lv5 抵達怪物首 tick 命中下降'],
      },
    ],
  },
  {
    ...
    resource: 'MP：大池但需要管理，護盾會把傷害轉成 MP 消耗。',
    ...
    skills: [
      {
        ...
        upgrades: ['Lv2 傷害 +8%', 'Lv3 命中提高', 'Lv4 低機率返還 MP', 'Lv5 對護盾中的自己額外穩定'],
      },
      {
        level: 1,
        name: '魔力護盾',
        role: '施法保護',
        scope: '自己',
        tickRule: '接下來數 tick 將部分傷害轉為 MP 消耗，降低詠唱被打斷風險。',
        upgrades: ['Lv2 吸收提高', 'Lv3 抗打斷提高', 'Lv4 MP 消耗降低', 'Lv5 護盾存在時火球更穩定'],
      },
      {
        level: 1,
        name: '火球術',
      ...
      },
      {
        ...
        role: '本房控場',
        scope: '本房間怪物',
        tickRule: '造成冰傷並 slow；受 slow 的 approaching 怪物 arrivalTicks +1。',
        upgrades: ['Lv2 傷害提高', 'Lv3 slow 強化', 'Lv4 低機率凍結', 'Lv5 對 approaching 怪物延遲更穩定'],
      },
      {
        level: 8,
        name: '暴風雪',
        ...
        upgrades: ['Lv2 傷害提高', 'Lv3 怪物命中下降', 'Lv4 arrivalTicks +1', 'Lv5 對四方怪附加 slow'],
      },
    ],
  },
  {
    ...
    tickCore: '先偵查、再標記、遠距削血，最後用陷阱處理 approaching 怪物。',
    resource: '專注：瞄準、等待與成功閃避回復；連續攻擊會消耗。',
    ...
    skills: [
      ...
      },
      {
        ...
        role: '機動防禦',
        scope: '自己',
        tickRule: '下一 tick 閃避提高；若成功閃避，下一次射擊增傷並回復專注。',
        upgrades: ['Lv2 閃避提高', 'Lv3 成功後回專注', 'Lv4 下一射命中提高', 'Lv5 成功閃避後可重置射擊 CD'],
      },
      {
        level: 1,
        name: '偵查',
        role: '相鄰房情報',
        scope: '指定方向',
        tickRule: '顯示指定相鄰房怪物，UI 記錄短時間偵查結果。',
      ...
      },
      {
        ...
        role: '高價值目標鎖定',
        scope: '本房間 / 已偵查相鄰房單體',
        tickRule: '標記目標；你對該目標傷害與命中提高。',
        upgrades: ['Lv2 傷害加成提高', 'Lv3 隊友也部分受益', 'Lv4 對標記目標射擊回專注', 'Lv5 標記目標抵達時陷阱傷害提高'],
      },
      {
        level: 8,
        name: '伏擊陷阱',
        role: '出口控制',
        scope: '指定出口',
        tickRule: 'approaching 怪物抵達該出口時觸發，造成傷害或 arrivalTicks +1。',
  ...
  },
  {
    ...
    tickCore: '治療與護盾維持節奏，聖光技能處理暗/undead，讓隊伍活過怪群抵達。',
    resource: '信仰：治療、淨化、防禦行動累積；審判與聖光爆發消耗。',
    ...
    skills: [
      {
        ...
        role: '光屬性攻擊',
        scope: '本房間單體',
        tickRule: '對暗/undead 額外有效；命中後可產生少量信仰。',
      ...
      },
      {
        ...
        role: '護盾',
        scope: '自己 / 隊友',
        tickRule: '接下來數 tick 吸收傷害；護盾受擊可產生信仰。',
        upgrades: ['Lv2 護盾提高', 'Lv3 可指定隊友', 'Lv4 被打產生信仰', 'Lv5 護盾破裂時小回復'],
      },
      {
        level: 5,
        name: '淨化',
      ...
      },
      {
        ...
        upgrades: ['Lv2 對 undead 傷害提高', 'Lv3 恐懼延遲', 'Lv4 隊友獲得小盾', 'Lv5 四方邪惡目標命中下降'],
      },
    ],
  },
];
        ...
        <section id="rules" className="scroll-mt-28 rounded-md border border-border-dim bg-bg-secondary p-4">
          ...
          <div className="mt-3 grid gap-3 text-sm md:grid-cols-2">
            ...
            <RuleBlock title="開局目標">
              玩家一創角就要感覺到職業差異：劍士控壓力、法師打大範圍、遊俠掌握情報、祭司撐住危局。
            </RuleBlock>
          </div>
        </section>
