...
export const ITEM_DEFS: Record<string, ItemDef> = {
  ...
  small_mp_potion: {
    id: 'small_mp_potion', name: '小型魔力藥水', type: 'consumable',
    description: '回復少量MP。', buyPrice: 25, sellPrice: 12,
    stackable: true, maxStack: 99, levelReq: 1,
    useEffect: { type: 'heal_mp', value: 30 },
  },
  medium_mp_potion: {
    id: 'medium_mp_potion', name: '中型魔力藥水', type: 'consumable',
    description: '回復中量MP。', buyPrice: 75, sellPrice: 37,
    stackable: true, maxStack: 99, levelReq: 5,
    useEffect: { type: 'heal_mp', value: 80 },
  },
  large_mp_potion: {
    id: 'large_mp_potion', name: '大型魔力藥水', type: 'consumable',
    description: '回復大量MP。', buyPrice: 180, sellPrice: 90,
    stackable: true, maxStack: 99, levelReq: 15,
