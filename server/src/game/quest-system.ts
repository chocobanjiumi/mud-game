...
export const EXPANDED_QUEST_DEFS: Record<string, QuestDef> = {
  ...
  main_03_forest_threat: {
    ...
    rewards: { exp: 800, gold: 400, equipmentSlotRewards: [{ slot: 'body', levelMax: 15, sourceTags: ['forest', 'main_quest'] }] },
  ...
  main_04_coastal_mystery: {
    ...
    rewards: { exp: 1200, gold: 600, equipmentSlotRewards: [{ slot: 'accessory', levelMax: 15, sourceTags: ['coast', 'main_quest'] }] },
  ...
  main_05_pirate_lord: {
    ...
    rewards: { exp: 1600, gold: 800, equipmentSlotRewards: [{ slot: 'weapon', levelMax: 18, sourceTags: ['coast', 'pirate', 'main_quest'] }] },
  ...
  main_06_volcano_seal: {
    ...
    rewards: { exp: 2200, gold: 1100, equipmentSlotRewards: [{ slot: 'hands', levelMax: 22, sourceTags: ['fire', 'volcano', 'main_quest'] }] },
  ...
  main_07_frozen_castle: {
    ...
    rewards: { exp: 2800, gold: 1400, equipmentSlotRewards: [{ slot: 'feet', levelMax: 28, sourceTags: ['ice', 'frozen', 'main_quest'] }] },
  ...
  main_08_demon_invasion: {
    ...
    rewards: { exp: 3500, gold: 1800, equipmentSlotRewards: [{ slot: 'body', levelMax: 36, sourceTags: ['dark', 'demon', 'main_quest'] }] },
  ...
  main_09_dragon_alliance: {
    ...
    rewards: { exp: 4500, gold: 2300, equipmentSlotRewards: [{ slot: 'weapon', levelMax: 46, sourceTags: ['dragon', 'main_quest'] }] },
  ...
  main_10_final_battle: {
    ...
    rewards: { exp: 6000, gold: 3000, equipmentSlotRewards: [{ slot: 'body', levelMax: 55, sourceTags: ['celestial', 'finale', 'main_quest'] }] },
