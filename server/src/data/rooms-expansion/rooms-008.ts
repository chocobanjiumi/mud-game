...
redrock_badlands_rock_giant_perch: {
    ...
    description:
      '紅礦切口上方是一片寬闊岩臺，地面留著巨大腳印，邊緣堆著被徒手掰碎的礦石與半埋巨石。岩石巨人會在這裡休眠，紅鱗蛇敵群也盤在溫熱礦縫旁，身體與紅岩幾乎融為一體，只有胸口裂縫偶爾透出暗色光。南側熱岩坡可看見火靈盆地，但巨人踩塌了下坡路，需由盆地熱岩坡上來。這裡是精英戰鬥與資源守門房，玩家可挑戰岩巨人、取得高品質石心與赤礦，也能從高處觀察火靈盆地和猩紅火口。戰鬥時要小心落石與其他玩家干擾，因為岩臺沒有太多遮蔽。若巨人被激怒，牠會把礦石投向下方切口，改變路線安全性。',
    exits: [
...
sunken_catacombs_floating_coffins: {
    ...
    description:
      '骨牆長廊後方是一間被水淹到腰深的墓室，數十具石棺漂在水面，彼此碰撞時發出沉悶聲響。棺蓋上刻著不同潮汐符號，部分石棺卻被從內部頂開。這裡是高密度戰鬥與任務房，玩家可辨認正確棺序、尋找任務遺骸，或用漂棺搭成臨時路線。石棺移動會改變出口位置，也會讓守墓骷髏和亡靈騎士更容易靠近。若水位突然下降，原本漂浮的棺材會變成阻擋退路的石牆。此處還留著可追蹤的任務痕跡、隱蔽標記與危險預兆，適合先仔細調查再推進。',
    exits: [
