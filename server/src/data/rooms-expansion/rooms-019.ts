...
ember_march_bonekiln_pass: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'ember_march_black_sand_basin', description: '西側骨窯隘口沿熔灰坡折返，穿過焦骨路標與蒸汽乾渠回到黑砂盆地' },
      { direction: 'north', targetRoomId: 'ember_march_fallen_banner', description: '北側骨窯隘口沿熱風窄口上攀，穿過骨灰階坡與燒斷軍旗列回到倒旗坡' },
...
ember_march_molten_toll: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'ember_march_border_keep_shell', description: '東側熔火關卡沿熔渣稅道折上，穿過坍塌門洞與燒紅鐵拒馬抵達邊堡外殼' },
    ],
    monsters: [
...
ember_march_dragonprint_ridge: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'ember_march_border_keep_shell', description: '北側龍印脊沿龍爪熱脊攀升，避開噴火裂縫後從焦黑外牆缺口抵達邊堡外殼' },
    ],
    monsters: [
...
ember_march_border_keep_shell: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'ember_march_molten_toll', description: '西側邊堡外殼沿坍塌門洞折返，穿過燒紅鐵拒馬與熔渣稅道回到熔火關卡' },
      { direction: 'south', targetRoomId: 'ember_march_dragonprint_ridge', description: '南側邊堡外殼從焦黑外牆缺口下切，穿過噴火裂縫與龍爪熱脊回到龍印脊' },
...
sapphire_lake_beast_scrape: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'sapphire_lake_glassfish_cove', description: '北側湖獸擦痕沿水下繩標繞過冷泉逆流，越過淺藍沙脊抵達玻魚灣' },
    ],
    monsters: [
...
sapphire_lake_glassfish_cove: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'sapphire_lake_beast_scrape', description: '南側玻魚灣水道沿水下繩標折回，穿過冷泉逆流與淺藍沙脊回到湖獸擦痕' },
...
sapphire_lake_sunken_step: {
    ...
    exits: [
      ...
      { direction: 'west', targetRoomId: 'sapphire_lake_glassfish_cove', description: '西側沉階水道繞過塌落石階與玻魚群，沿斜光浮標與淺水石縫回到玻魚灣' },
      { direction: 'north', targetRoomId: 'sapphire_lake_deep_vein_window', description: '北側沉階沿礦光石階下探，穿過冷水暗流與藍砂斜坡後抵達深脈窗' },
    ],
    monsters: [
...
sapphire_lake_lily_cache: {
    ...
    exits: [
      { direction: 'east', targetRoomId: 'sapphire_lake_sapphire_lode', description: '東側睡蓮根道穿過浮葉陰影與藍光裂縫，沿礦砂繩標抵達藍寶礦脈' },
    ],
    monsters: [
      { monsterId: 'sapphire_reed_sprite', maxCount: 2, respawnSeconds: 220 },
      { monsterId: 'mirror_shallows_serpent', maxCount: 1, respawnSeconds: 230 },
...
sapphire_lake_spirit_mirror: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'sapphire_lake_deep_vein_window', description: '東側水靈鏡面沿倒影水道折行，越過光紋淺坡與水幕裂隙抵達深脈窗' },
    ],
    monsters: [
      { monsterId: 'sapphire_reed_sprite', maxCount: 1, respawnSeconds: 220 },
      { monsterId: 'calmwater_spring_guardian', maxCount: 1, respawnSeconds: 380 },
...
sapphire_lake_deep_vein_window: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'sapphire_lake_spirit_mirror', description: '西側深脈窗沿倒影水道回折，穿過光紋淺坡與水幕裂隙後回到水靈鏡' },
      { direction: 'south', targetRoomId: 'sapphire_lake_sunken_step', description: '南側深脈窗沿礦光石階上返，穿過冷水暗流與藍砂斜坡後回到沉階' },
      { direction: 'east', targetRoomId: 'sapphire_lake_sapphire_lode', description: '東側深脈窗穿過藍光礦裂與水壓窄門，沿發亮礦脊與碎晶坡抵達藍寶礦脈' },
    ],
    monsters: [
      { monsterId: 'blue_lode_golem', maxCount: 1, respawnSeconds: 360 },
      { monsterId: 'mirror_shallows_serpent', maxCount: 1, respawnSeconds: 230 },
...
sapphire_lake_sapphire_lode: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'sapphire_lake_lily_cache', description: '西側藍寶礦脈沿礦砂繩標折返，穿過浮葉陰影與睡蓮根道回到藏點' },
