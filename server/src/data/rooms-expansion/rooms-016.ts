...
pilgrim_road_bandit_watch: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'pilgrim_road_sunset_camp', description: '東側盜匪望臺沿暗哨土脊橫移，繞過瞭望繩梯與落日營火線抵達日暮營地' },
    ],
    monsters: [
      { monsterId: 'smuggler_cache_guard', maxCount: 1, respawnSeconds: 300 },
      { monsterId: 'caravan_rut_cutpurse', maxCount: 2, respawnSeconds: 95 },
...
pilgrim_road_old_cemetery_turn: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'pilgrim_road_sunset_camp', description: '南側舊墓岔路沿碎墓碑小徑斜落，穿過枯草墓牆與落日營火線抵達日暮營地' },
    ],
    monsters: [
      { monsterId: 'saint_bridge_penitent', maxCount: 1, respawnSeconds: 260 },
...
pilgrim_road_sunset_camp: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'pilgrim_road_old_cemetery_turn', description: '北側日暮營地沿落日營火線回穿，穿過枯草墓牆與碎墓碑小徑回到舊墓岔路' },
      { direction: 'east', targetRoomId: 'pilgrim_road_sanctuary_gate', description: '聖地門在東側' },
      { direction: 'south', targetRoomId: 'sapphire_lake_entry_claim', description: '南側白石路標沿乾涸支道下切，越過湖岸礫坡通往藍寶石湖入口界標' },
    ],
    monsters: [
...
pilgrim_road_sanctuary_gate: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'sapphire_lake_vein_path', description: '南側聖地門階道沿礦脈石徑下降，接入藍寶石湖畔的發光礦脈路' },
      {
        direction: 'north',
...
pilgrim_road_quiet_overlook: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'lakeside_tailor', description: '東側布旗小徑穿過古道望臺與湖畔商業巷，抵達城鎮裁縫坊門前' },
      {
        direction: 'west',
        targetRoomId: 'lakeside_town_fill_15_6',
...
ironwood_fort_barracks_hall: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'ironwood_fort_war_room', description: '東側軍械牆道穿過兵器架與戰旗廊，繞過上層轉角後抵達戰圖室門前' },
      { direction: 'north', targetRoomId: 'ironwood_fort_scout_roost', description: '北側哨兵木梯沿外牆折上，越過箭孔平台與守備吊橋後抵達斥候棲臺' },
    ],
    monsters: [
      { monsterId: 'ironwood_gate_sentinel', maxCount: 2, respawnSeconds: 120 },
...
ironwood_fort_signal_tower: {
    ...
    exits: [
      ...
      { direction: 'west', targetRoomId: 'ironwood_fort_war_room', description: '西側信號牆道繞過烽火燃料架與旗語平台，沿塔身陰影通往戰圖室後門' },
...
ironwood_fort_war_room: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'ironwood_fort_barracks_hall', description: '西側戰旗廊穿過戰圖桌與軍械牆道，繞過上層轉角折回兵營大廳內門' },
      { direction: 'east', targetRoomId: 'ironwood_fort_signal_tower', description: '東側旗語平台繞過烽火燃料架，沿塔身陰影與石階通往烽火信號塔內梯' },
...
ironwood_fort_scout_roost: {
    ...
    exits: [
      { direction: 'east', targetRoomId: 'ironwood_fort_barracks_hall', description: '東側外牆平台沿哨兵木梯折降，穿過箭孔陰影與守備吊橋回到兵營大廳' },
...
ironwood_fort_command_walk: {
    ...
    exits: [
      ...
      { direction: 'west', targetRoomId: 'ironwood_fort_oath_chapel', description: '西側指揮長廊越過封令拱門與軍官座席，繞過戰旗屏風接到誓約禮拜堂側門' },
...
ironwood_fort_oath_chapel: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'ironwood_fort_command_walk', description: '東側側門穿過封令拱門與軍官座席，繞過戰旗屏風接回指揮長廊中央' },
      { direction: 'north', targetRoomId: 'ironwood_fort_keep_gate', description: '北側宣誓階梯沿黑鐵聖徽上行，繞過內堡閘鏈與守門鐵柱抵達內堡門' },
    ],
    monsters: [
...
ironwood_fort_keep_gate: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'ironwood_fort_oath_chapel', description: '南側內堡閘鏈旁的宣誓階梯折降，沿黑鐵聖徽與守門鐵柱回到誓約禮拜堂' },
