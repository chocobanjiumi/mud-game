...
storm_highlands_griffin_watch: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'storm_highlands_thunder_pool', description: '哨臺南側濕滑階梯沿雲霧與斷纜折落，繞過落雷濕岩後抵達雷雨池外圈' },
    ],
    monsters: [
...
storm_highlands_thunder_pool: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'storm_highlands_griffin_watch', description: '北側濕階逆著雷雨與雲霧繞過斷纜，沿滑石折坡回到獅鷲哨臺下方' },
