...
frostbite_pass_caravan_marker: {
    ...
    description:
      '商隊路標位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_icewind_cut: {
    ...
    description:
      '冰風切道位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_frozen_switchback: {
    ...
    description:
      '凍結折路位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_buried_wagon: {
    ...
    description:
      '埋雪貨車位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_blue_ice_bridge: {
    ...
    description:
      '藍冰橋位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_yeti_scrape: {
    ...
    description:
      '雪怪抓痕位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_whiteout_basin: {
    ...
    description:
      '白霧盆地位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_coldfire_camp: {
    ...
    description:
      '冷火營位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_glacier_mouth: {
    ...
    description:
      '冰河口位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_sleet_watch: {
    ...
    description:
      '雨雪哨位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。南側白霧盆地被暴風雪回流遮斷，只能從白霧盆地東側抵達雨雪哨。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_bone_sled_path: {
    ...
    description:
      '骨橇路位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_crystal_fir_grove: {
    ...
    description:
      '晶松林位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_wind_howl_arch: {
    ...
    description:
      '風嚎拱位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_lost_merchant_cache: {
    ...
    description:
      '失商藏點位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_frost_giant_steps: {
    ...
    description:
      '霜巨人足跡位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_ice_cairn_field: {
    ...
    description:
      '冰石堆原位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_northbound_ridge: {
    ...
    description:
      '北行山脊位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_dragon_breath_shelf: {
    ...
    description:
      '龍息冰棚位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
frostbite_pass_polar_seal_gate: {
    ...
    description:
      '極北封門位於通往極北且長年結冰的霜咬隘口，雪門、商隊路標、藍冰橋、白霧盆地、冰河口與失蹤貨車共同標出危險的高寒通道。這裡是高密度野外遭遇與精英巡邏區，旅人可以 觀察 雪面足跡、斷裂繩標、冰橋裂紋和風向旗來判斷暴風雪間隙，也能 search 埋雪貨車、冷火營、失商藏點與冰石堆原尋找商隊線索。若隊伍忽略白霧回流、雪怪抓痕與冰龍吐息，雪狼、雪人、霜巨人與冰元素會在窄路包抄；若穩定沿路標、骨橇道與北行山脊推進，則能抵達極北封門並帶回失蹤商隊記錄、冰橋測量與避風路線標記與雪盲防護記錄',
    exits: [
...
// ─── 死都外門擴充 (Lv 40-52) ───────────────────────────
  ...
  necropolis_gate_black_approach: {
    ...
    description:
      '黑門引道位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_half_open_gate: {
    ...
    description:
      '半開黑門位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_bone_causeway: {
    ...
    description:
      '白骨堤道位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_silent_muster: {
    ...
    description:
      '靜默列陣位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_grave_banner_line: {
    ...
    description:
      '墓旗線位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_iron_ossuary: {
    ...
    description:
      '鐵骨藏室位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_soul_well: {
    ...
    description:
      '魂井位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_mourner_steps: {
    ...
    description:
      '哀悼階位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_watchless_tower: {
    ...
    description:
      '無守望塔位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_crypt_market: {
    ...
    description:
      '墓市廊位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_war_drum_yard: {
    ...
    description:
      '戰鼓庭位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_charnel_bridge: {
    ...
    imagePrompt: '屍橋 in necropolis_gate, necropolis gate endgame dark fortress with half open black gate, bone causeway, undead army formation, soul well, void crack, dark fantasy painterly environment illustration, vertical 10:16, consistent style, no UI, no text, room function entrance, terrain gate, clear lantern light',
    description:
      '屍橋位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_wight_barracks: {
    ...
    description:
      '怨衛兵營位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_plague_censer: {
    ...
    description:
      '疫香爐位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_eclipsed_statue: {
    ...
    description:
      '蝕日雕像位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_death_roll_archive: {
    ...
    description:
      '死亡名冊庫位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_void_crack: {
    ...
    description:
      '虛空裂縫位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_inner_portcullis: {
    ...
    description:
      '內城閘位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_bone_throne_antechamber: {
    ...
    description:
      '骨王座前廳位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
necropolis_gate_dead_city_threshold: {
    ...
    description:
      '死都門檻位於通往死者之城的巨大黑門前，半開門縫、白骨堤道、墓旗線、魂井、屍橋與無人守望塔共同標出終局戰場的入口。這裡是陣營衝突、精英巡邏與世界王前哨區，旅人可以 觀察 軍靴刻痕、墓旗符號、魂井回聲和內城閘鎖來判斷亡軍動向，也能 search 鐵骨藏室、墓市廊、死亡名冊庫與骨王座前廳尋找死都線索。若隊伍忽略戰鼓節奏、虛空裂縫與怨衛列隊，巫妖、魔族將軍、虛空行者與深淵領主會封鎖撤退；若穩定沿黑門、屍橋與內城閘推進，則能抵達死都門檻並帶回亡軍集結記錄、黑門符印與陣營戰報與撤退暗號',
    exits: [
...
// ─── 日耀尖塔擴充 (Lv 45-58) ───────────────────────────
  ...
  sunspire_white_stone_gate: {
    ...
    description:
      '白石塔門位於直入雲層並吸收日光的日耀尖塔內，白石階、焰玻步道、聚光鏡室、聖歌廊與塔頂聖火共同構成神聖力量的終局試煉。這裡是高階隊伍、陣營衝突與世界王前哨區，旅人可以 觀察 日輪刻痕、鏡面角度、聖歌殘響和戰神印記來判斷塔內光流，也能 search 太陽武庫、燃書庫、天界守衛廳與塔頂前室尋找神聖線索。若隊伍忽略日火脈衝、翼影巡邏與光焰反噬，龍騎士、天界守衛、熾天使與神造兵器會封住上行路；若穩定沿日光階、金焰橋與熾天使哨臺推進，則能抵達日冠核心並帶回神聖試煉記錄、光流測量、聖火封印與安全下行路線',
    exits: [
...
sunspire_sunlit_stair: {
    ...
    description:
      '日光階位於直入雲層並吸收日光的日耀尖塔內，白石階、焰玻步道、聚光鏡室、聖歌廊與塔頂聖火共同構成神聖力量的終局試煉。這裡是高階隊伍、陣營衝突與世界王前哨區，旅人可以 觀察 日輪刻痕、鏡面角度、聖歌殘響和戰神印記來判斷塔內光流，也能 search 太陽武庫、燃書庫、天界守衛廳與塔頂前室尋找神聖線索。若隊伍忽略日火脈衝、翼影巡邏與光焰反噬，龍騎士、天界守衛、熾天使與神造兵器會封住上行路；若穩定沿日光階、金焰橋與熾天使哨臺推進，則能抵達日冠核心並帶回神聖試煉記錄、光流測量、聖火封印與安全下行路線',
    exits: [
...
sunspire_mirror_plinth: {
    ...
    description:
      '鏡石臺位於直入雲層並吸收日光的日耀尖塔內，白石階、焰玻步道、聚光鏡室、聖歌廊與塔頂聖火共同構成神聖力量的終局試煉。這裡是高階隊伍、陣營衝突與世界王前哨區，旅人可以 觀察 日輪刻痕、鏡面角度、聖歌殘響和戰神印記來判斷塔內光流，也能 search 太陽武庫、燃書庫、天界守衛廳與塔頂前室尋找神聖線索。若隊伍忽略日火脈衝、翼影巡邏與光焰反噬，龍騎士、天界守衛、熾天使與神造兵器會封住上行路；若穩定沿日光階、金焰橋與熾天使哨臺推進，則能抵達日冠核心並帶回神聖試煉記錄、光流測量、聖火封印與安全下行路線',
    exits: [
...
sunspire_flameglass_walk: {
    ...
    description:
      '焰玻步道位於直入雲層並吸收日光的日耀尖塔內，白石階、焰玻步道、聚光鏡室、聖歌廊與塔頂聖火共同構成神聖力量的終局試煉。這裡是高階隊伍、陣營衝突與世界王前哨區，旅人可以 觀察 日輪刻痕、鏡面角度、聖歌殘響和戰神印記來判斷塔內光流，也能 search 太陽武庫、燃書庫、天界守衛廳與塔頂前室尋找神聖線索。若隊伍忽略日火脈衝、翼影巡邏與光焰反噬，龍騎士、天界守衛、熾天使與神造兵器會封住上行路；若穩定沿日光階、金焰橋與熾天使哨臺推進，則能抵達日冠核心並帶回神聖試煉記錄、光流測量、聖火封印與安全下行路線',
    exits: [
...
sunspire_radiant_lift: {
    ...
    description:
      '日耀升降井位於直入雲層並吸收日光的日耀尖塔內，白石階、焰玻步道、聚光鏡室、聖歌廊與塔頂聖火共同構成神聖力量的終局試煉。這裡是高階隊伍、陣營衝突與世界王前哨區，旅人可以 觀察 日輪刻痕、鏡面角度、聖歌殘響和戰神印記來判斷塔內光流，也能 search 太陽武庫、燃書庫、天界守衛廳與塔頂前室尋找神聖線索。若隊伍忽略日火脈衝、翼影巡邏與光焰反噬，龍騎士、天界守衛、熾天使與神造兵器會封住上行路；若穩定沿日光階、金焰橋與熾天使哨臺推進，則能抵達日冠核心並帶回神聖試煉記錄、光流測量、聖火封印與安全下行路線',
    exits: [
...
sunspire_solar_armory: {
    ...
    description:
      '太陽武庫位於直入雲層並吸收日光的日耀尖塔內，白石階、焰玻步道、聚光鏡室、聖歌廊與塔頂聖火共同構成神聖力量的終局試煉。這裡是高階隊伍、陣營衝突與世界王前哨區，旅人可以 觀察 日輪刻痕、鏡面角度、聖歌殘響和戰神印記來判斷塔內光流，也能 search 太陽武庫、燃書庫、天界守衛廳與塔頂前室尋找神聖線索。若隊伍忽略日火脈衝、翼影巡邏與光焰反噬，龍騎士、天界守衛、熾天使與神造兵器會封住上行路；若穩定沿日光階、金焰橋與熾天使哨臺推進，則能抵達日冠核心並帶回神聖試煉記錄、光流測量、聖火封印與安全下行路線',
    exits: [
