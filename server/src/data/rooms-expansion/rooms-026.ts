...
// ─── 王國邊境擴充 (Lv 25-60) ───────────────────────────
  ...
  kingdom_frontier_portal_muster: {
    ...
    description:
      '傳送點兵場位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_border_road: {
    ...
    description:
      '邊境軍路位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_watchtower_west: {
    ...
    description:
      '西哨塔位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_supply_camp: {
    ...
    description:
      '補給營位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_battlefield_crossing: {
    ...
    description:
      '戰場岔口位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_watchtower_east: {
    ...
    description:
      '東哨塔位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_lumber_claim: {
    ...
    description:
      '木材據點位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_iron_claim: {
    ...
    description:
      '鐵礦據點位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_siege_yard: {
    ...
    description:
      '攻城器械場位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_banner_hill: {
    ...
    description:
      '戰旗丘位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_truce_tent: {
    ...
    description:
      '停戰帳位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_burnt_farmstead: {
    ...
    description:
      '焚農莊位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_darkwood_cut: {
    ...
    description:
      '暗林缺口位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_firebreak_ridge: {
    ...
    description:
      '防火嶺位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_spyglass_ruin: {
    ...
    description:
      '望遠鏡遺跡位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_treasury_wagon: {
    ...
    description:
      '國庫車隊位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_prisoner_stockade: {
    ...
    description:
      '俘虜柵欄位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_redoubt_gate: {
    ...
    description:
      '前壘門位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_war_table_bunker: {
    ...
    description:
      '戰圖地堡位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
...
kingdom_frontier_command_front: {
    ...
    description:
      '前線指揮所位於各王國勢力交錯的王國邊境，傳送點兵場、哨塔、補給營、資源據點、戰旗丘與前線地堡隨戰線推移反覆易手。這裡是王國戰、資源戰與開放衝突區，旅人可以 觀察 旗幟顏色、車轍方向、哨塔火盆和戰圖標記來判斷敵我控制，也能 搜索 木材據點、鐵礦據點、國庫車隊與戰圖地堡尋找軍需、稅銀、攻城零件與密令。若隊伍忽略偵騎號角、防火嶺煙線與暗林缺口的伏兵，龍騎士、深淵軍、天界守衛與戰神化身會把補給線切斷；若穩定沿傳送點兵場、前壘門與前線指揮所推進，則能帶回王國戰報、資源控制記錄、撤退路線與可交付的前線軍令',
    exits: [
