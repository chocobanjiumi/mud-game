...
moonlit_fen_willow_hush: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'moonlit_fen_silver_mire', description: '南側靜柳叢沿露出水面的柳根路斜落，穿過銀霧水洼與倒影草線抵達銀泥沼' },
    ],
    monsters: [
...
moonlit_fen_silver_mire: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'moonlit_fen_willow_hush', description: '北側銀泥沼沿倒影草線上行，穿過銀霧水洼與露根水道回到靜柳叢' },
...
moonlit_fen_frog_choir: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'moonlit_fen_mosquito_haze', description: '南側蛙鳴洲沿濕草道斜落，穿過蛙卵淺灣、月影水痕與銀蚊霧帶抵達蚊霧溝' },
    ],
    monsters: [
...
moonlit_fen_mosquito_haze: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'moonlit_fen_frog_choir', description: '北側蚊霧溝沿銀蚊霧帶回穿，踏過月影水痕、蛙卵淺灣與濕草道回到蛙鳴洲' },
...
moonlit_fen_sunken_log_bridge: {
    ...
    exits: [
      { direction: 'north', targetRoomId: 'moonlit_fen_fill_18_13', description: '北側沉木支脈沿黑水汊道上行，回到月沼北汊' },
...
moonlit_fen_moonwell: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'moonlit_fen_white_reed_maze', description: '南側月井沿井邊濕石路斜落，穿過月影水紋與白蘆迴圈入口抵達白蘆迷道' },
    ],
    monsters: [
      { monsterId: 'fae_ring_trickster', maxCount: 1, respawnSeconds: 240 },
...
moonlit_fen_white_reed_maze: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'moonlit_fen_moonwell', description: '北側白蘆迷道沿白蘆迴圈折返，穿過月影水紋與井邊濕石路回到月井' },
...
moonlit_fen_old_canoe_camp: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'moonlit_fen_lunar_altar', description: '東側舊舟營沿半沉舟痕橫渡，繞過黑水倒影與白蘆暗汊抵達月沼祭壇' },
    ],
    monsters: [
      { monsterId: 'white_reed_stalker', maxCount: 1, respawnSeconds: 260 },
      { monsterId: 'blackwater_leech_bloom', maxCount: 2, respawnSeconds: 110 },
...
pilgrim_road_bell_shrine: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'pilgrim_road_caravan_rut', description: '南側鐘鈴小祠沿破碎祈願石階斜落，穿過白石路標與深車轍抵達商隊車轍' },
    ],
    monsters: [
...
pilgrim_road_caravan_rut: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'pilgrim_road_bell_shrine', description: '北側商隊車轍沿深車轍上行，穿過白石路標與破碎祈願石階回到鐘鈴小祠' },
...
pilgrim_road_abandoned_inn: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'pilgrim_road_thorn_cut', description: '南側廢棄旅舍從坍塌後門下切，穿過乾草貨棚與荊棘暗口抵達荊棘缺口' },
    ],
    monsters: [
      { monsterId: 'caravan_rut_cutpurse', maxCount: 2, respawnSeconds: 95 },
      { monsterId: 'drywell_ambusher', maxCount: 1, respawnSeconds: 110 },
...
pilgrim_road_thorn_cut: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'pilgrim_road_abandoned_inn', description: '北側荊棘缺口沿荊棘暗口回穿，越過乾草貨棚與坍塌後門回到廢棄旅舍' },
