...
"frozen_wastes_fill_n25_n23": {
    ...
    "name": "北境王座南雪封",
    "zone": "frozen_wastes",
    "description": "北境王座南雪封位在冰封雪原最北側，南面廢棄雪橇的車轍早被風雪抹淡，西側冰封王座藍光隔著白霧閃動。凍土小路在冰面裂聲中突然中斷，雪面插著碎冰旗與裂縫警樁。冰殼下方傳來空洞回音，北側沒有穩固地面，只有被霜封住的矮石和滑落雪粉；這裡像王座外圍被寒流鎖死的南界。近旁霜粉、斷枝與被風磨亮的冰痕持續標出回程方向，也讓周圍危險在白茫茫雪光中保留清楚輪廓。",
...
"frozen_wastes_fill_n26_n18": {
    ...
    "name": "龍息裂谷西冰封",
    "zone": "frozen_wastes",
    "description": "龍息裂谷西冰封位在裂谷西側，東面藍色霜光從深縫吐出，北邊冰晶尖塔反射淡白光。凍結通道被橫向冰牆切斷，牆面夾著黑色岩屑與被寒風拉長的裂紋。冰牆腳下堆滿碎雪、硬霜和凍裂鎧片，沒有可繞行的凹口；每次裂谷噴出冷流，牆面都會發出細小爆裂聲，把背面道路重新封緊。近旁霜粉、斷枝與被風磨亮的冰痕持續標出回程方向，也讓周圍危險在白茫茫雪光中保留清楚輪廓。",
...
"frozen_wastes_fill_n24_n17": {
    ...
    "name": "龍息裂谷東雪脊封",
    "zone": "frozen_wastes",
    "description": "龍息裂谷東雪脊封被冰風削成狹長雪脊，西側龍息裂谷外緣泛著藍色霜光，北面深白霧遮住冰封城堡方向，南側裂谷雪徑貼著斷冰下降。雪脊表面覆著風削硬殼和碎冰旗，外側立刻落入看不見底的霧谷。東面雪原沒有連續踏點，只有被寒流磨亮的冰稜和凍土裂聲，像裂谷把整片東側荒地硬生生切斷。",
...
"frozen_wastes_fill_n24_n18": {
    ...
    "name": "裂谷雪徑",
    "zone": "frozen_wastes",
    "description": "裂谷雪徑沿龍息裂谷旁的窄坡延伸，西側能回望裂谷藍霜，北側雪脊被白霧封成高牆。雪徑本身被凍霧覆住，只有幾段黑色岩棱與結冰腳印露出，邊緣掛著被寒流吹出的雪簾。南北方向的坡面差異清楚，裂谷風從西側不斷拍打路面；這段雪徑像東側區域少數仍能辨認的連接痕跡。近旁霜粉、斷枝與被風磨亮的冰痕持續標出回程方向，也讓周圍危險在白茫茫雪光中保留清楚輪廓。",
...
"glass_dunes_fill_1_19": {
    ...
    "name": "西北凝砂封坡",
    "zone": "glass_dunes",
    "description": "西北凝砂封坡像一排凝固浪頭，透明砂殼從坡頂垂下，邊緣鋒利得能割開靴底。北側熱風將碎砂吹成白色橫線，東面較低的沙脊才露出暗淡可踏的粗砂。坡腳散著破繩、碎石標與幾片被風磨圓的紅岩，顯示曾有人試圖沿外緣繞行，最後只留下被砂吞掉的痕跡。陽光照進砂殼時，內部裂縫像冰層一樣明亮，任何細小震動都會讓整片坡面滑落。",
...
"glass_dunes_fill_1_22": {
    ...
    "name": "西南玻浪牆",
    "zone": "glass_dunes",
    "description": "西南玻浪牆由大片透明砂殼堆成，高處像被浪濤凍住的玻璃，底部則積著鬆散流砂。北側仍能望見日照西門的白光，東面沙丘裂口露出較暗的穩定砂帶，南方只剩翻滾熱浪。牆下有斷裂繩標與被拖歪的石旗，旗面早被風磨得看不出徽記。日光穿過砂殼時會折出七彩光斑，漂亮卻危險；光斑移動越快，代表下方砂層越不穩。",
...
"glass_dunes_fill_2_23": {
    ...
    "name": "西南砂殼封口",
    "zone": "glass_dunes",
    "description": "西南砂殼封口覆著厚而脆的玻砂硬殼，表面看似平整，邊緣卻不停塌落出細小暗洞。西面熱風捲來白砂，東側遠處有沙丘主路的繩標與低矮石旗，南方只見被光吞沒的坡面。硬殼下偶爾傳來空響，幾段舊腳印在中途消失，被新砂填成模糊凹痕。殼面裂紋交錯如龜甲，裂縫裡閃著潮濕冷光，說明下方不是堅地，而是會緩慢移動的流砂層。",
...
"glass_dunes_fill_3_19": {
    ...
    "name": "碎玻窄脊",
    "zone": "glass_dunes",
    "description": "碎玻窄脊夾在鹽風切谷與玻暴盆地之間，脊面窄得只容一串腳印通過，兩旁都是會滑落的透明砂坡。西側鹽霧把砂粒染成灰白，東面盆地深處不斷捲起細碎旋風，脊背上的繩結被磨到發亮。幾塊破玻片立在邊緣，反射出錯亂的路影，只有被鹽風刮暗的中央砂帶保持粗糙。行至中段時能看見下方埋著半圈王朝石環，似乎用來固定早已崩毀的防風棧道。",
...
"glass_dunes_fill_3_23": {
    ...
    "name": "南風沙脊欄",
    "zone": "glass_dunes",
    "description": "南風沙脊欄被長年熱風削成細長弧線，砂脊一側仍有北方主路留下的淡淡腳印，另一側則被流動白砂吞沒。東面熱浪遮住更深沙海，西側碎玻與鹽霧混成灰亮邊帶。脊欄上插著幾根低矮石樁，樁身被玻砂磨出斜痕，繩索早已斷成硬結。日照強烈時，砂脊頂端會像燃起白火，底部卻傳出滑砂聲，顯示外側坡面正在慢慢崩落。",
...
"glass_dunes_fill_4_23": {
    ...
    "name": "南晶砂採痕",
    "zone": "glass_dunes",
    "description": "南晶砂採痕散在低矮沙丘之間，北側能回望碎玻窄脊，東面晶砂閃得像被風吹皺的水面。地上有淺坑、破篩框與斷掉的布繩，透明砂粒在坑底堆成小小尖塔，像開採後又被風重新塑形。南側坡面缺少固定石標，白砂下傳來悶悶空響，只有北側暗色砂帶較穩。幾片王朝陶符混在晶屑裡，符面被磨得發亮，顯示這片採痕靠近舊礦脈外沿。",
...
"glass_dunes_fill_4_24": {
    ...
    "name": "南側七彩砂壁",
    "zone": "glass_dunes",
    "description": "南側七彩砂壁在陽光下折出大片虹光，砂壁上層透明，下層混著赤褐石粉，像沙丘把外圍荒地與玻海壓成一面斷牆。北面可見晶砂小徑的淺坑與破篩，南側陡壁過亮，沒有穩定落腳處。壁腳堆著滑落砂殼、斷石旗與被磨成粉的繩索，風一吹便沿牆面灑下細小玻屑。虹光雖清晰，卻會遮住裂縫陰影，使整面砂壁顯得華麗而不可親近。",
...
"glass_dunes_fill_5_19": {
    ...
    "name": "北中玻砂封坡",
    "zone": "glass_dunes",
    "description": "北中玻砂封坡覆著大片透明砂粒，西側折光砂道仍有白線反光，南面則落入鬆散沙谷。坡頂像凝固海浪，波紋間夾著細小晶核與灰色鹽粉，沒有明顯踏點。幾枚舊石釘被風磨到只剩圓頭，旁邊的繩痕已被新砂填平。光線從坡面穿下去時，能看見內部裂成多層薄殼，任何重壓都可能讓砂殼分層滑落，把外緣與主沙路徹底隔開。",
...
"glass_dunes_fill_5_23": {
    ...
    "name": "南緣碎浪坡",
    "zone": "glass_dunes",
    "description": "南緣碎浪坡貼著沙海邊界，北側主路繩標被風埋住一半，東面砂面持續崩落成一排細碎浪痕。坡上透明砂殼與白色細砂交錯，踩過的痕跡很快被熱風抹平。幾塊石旗倒在砂裡，旗座周圍露出暗色裂縫，裂縫深處偶爾反出冷光。坡外看似平緩，實際下方全是滑動流砂，只有回望北側時，才能看見較粗暗砂連回穩定沙脊。",
...
"glass_dunes_fill_6_23": {
    ...
    "name": "東南玻砂欄",
    "zone": "glass_dunes",
    "description": "東南玻砂欄在沙丘外圈形成低矮弧線，西側能看見南緣碎浪坡，東面熱浪後方沒有固定路標。欄形砂脊由透明硬殼與鬆砂堆成，表面滿是風蝕斜紋，像一排天然欄杆攔住外側流砂。幾處晶砂採痕停在欄內，破篩與碎陶都朝西倒伏，顯示風勢長年由外海般的沙面壓來。陽光貼著砂欄滑動時，裂縫會一條條亮起，把可辨的內側邊界清楚勾出。",
...
"glass_dunes_fill_7_20": {
    ...
    "name": "東側日焰封線",
    "zone": "glass_dunes",
    "description": "東側日焰封線靠近琉璃沙丘外緣，西南面主路仍留有淡淡腳印，東側熱光把砂面照成白焰。封線不是石牆，而是一長排過度熔化的玻砂脊，脊背閃著刺眼金白色，底部則有黑紅熔痕。沒有繩標延向更東方，只有幾根被燒短的木樁倒在內側暗砂裡。風越大，白焰般的反光越會遮住地面起伏，讓外緣看似空曠，實際卻充滿薄殼與塌陷暗洞。",
...
"glass_dunes_fill_7_22": {
    ...
    "name": "東南晶裂採坑",
    "zone": "glass_dunes",
    "description": "東南晶裂採坑散著細碎透明晶砂，北側日焰封線反光刺眼，西面則能看見較低的砂谷。坑邊有破篩、半截繩樁與被風磨亮的陶片，透明晶粒在裂縫中堆成細線，像礦脈延伸到此處後突然斷裂。南東兩側缺少石旗，砂面過亮且帶空響，顯示坑外已進入不穩定邊坡。若光線稍暗，能見到坑底有幾片帶王朝紋的玻瓦，混在晶屑中仍保留微弱藍光。",
...
"ironwood_fort_fill_0_12": {
    ...
    "name": "傳送庭北牆根封",
    "zone": "ironwood_fort",
    "description": "傳送庭北牆根封位在鐵木要塞西北牆腳，南側傳送陣庭的藍光貼著石縫閃爍，東邊舊蓄水池送來濕冷水聲。北面城牆垛口被黑石和鐵木梁完全堵住，牆根堆著碎板、廢釘與褪色補給牌。潮氣使石面長出深綠苔痕，偶爾有陣光把苔影照成細碎紋路。這片牆腳不像通道，更像防線背後的死角，能看見要塞把每個外露缺口都用厚重材料封實。",
...
"ironwood_fort_fill_0_17": {
    ...
    "name": "鐵木林南補給封道",
    "zone": "ironwood_fort",
    "description": "鐵木林南補給封道貼著要塞西牆延伸，北側鐵木林圃的根系從石縫鑽出，南面兵營通路被拒馬與倒塌貨架截斷，東邊囚牢外牆只露出窄窄鐵窗。地上散著補給牌、斷麻繩與被雨水泡黑的木箱角，牆面有拖運車輪留下的斜痕。根系把部分石板抬起，形成凹凸暗影，使這條封道保留著曾經運送物資的痕跡，也明確顯出如今被內部守備切斷的狀態。",
...
"ironwood_fort_fill_0_18": {
    ...
    "name": "南牆兵營玻砂界",
    "zone": "ironwood_fort",
    "description": "南牆兵營玻砂界位在鐵木要塞最南牆腳，北面補給封道仍有軍靴刮痕，東側琉璃沙丘北緣的晶砂已堆到牆根。黑石牆下坍著鐵木拒馬，透明砂粒卡在木刺和軍牌之間，日光從砂面反上來，把牆影照得發白。南方牆外沒有完整坡道，只剩被沙掩住的斷樁與碎石。此處像要塞與玻砂荒地互相擠壓的裂線，軍事秩序在牆內延續，牆外則被刺眼流砂吞沒。",
...
"glass_dunes_fill_1_18": {
    ...
    "name": "北緣晶砂",
    "zone": "glass_dunes",
    "description": "北緣晶砂貼著琉璃沙丘北側展開，碎玻砂在風裡閃成一片白線，遠處仍可看見鐵木要塞的灰暗牆影。南面沙丘逐漸升高，晶砂厚度也變得更深，北側則被硬化砂殼與熱風斷層切住。地上有幾枚被磨平的舊釘與細小採痕，像外圍巡路曾在此停步。當光線壓低時，砂面會映出要塞輪廓與沙丘主脊的雙重影子，使這片北緣既像入口，又像被玻光封住的邊界。",
...
"glass_dunes_fill_2_18": {
    ...
    "name": "玻砂北徑",
    "zone": "glass_dunes",
    "description": "玻砂北徑沿乾熱風線延伸，腳下碎鏡般的砂粒每一步都磨出細響。南側沙丘升起成白亮脊背，北面要塞石牆只剩被熱浪扭曲的低沉輪廓。路旁沒有完整門標，只有幾塊壓在砂下的黑石與半截木釘，暗示北側外緣早已被風口切斷。若低頭看砂面，能見到細小晶片按照風向排成長線，線末止於一片過亮的硬殼，像自然形成的警戒邊。",
...
"glass_dunes_fill_3_18": {
    ...
    "name": "熱風砂脊",
    "zone": "glass_dunes",
    "description": "熱風砂脊把北方硬土切成一條透明亮線，東西兩側的晶砂在風裡起伏，往南可看見琉璃沙丘內部刺眼反光。脊頂沒有路標，只有被熱風燒黑的石片半埋在砂中，像一串失效的邊界刻度。風穿過此處時溫度驟升，砂粒會順著坡面成片滑動，露出下方更亮的玻殼。遠處主路雖隱約可見，兩者之間隔著細密裂縫與空響，讓這條砂脊更像地貌斷線。",
...
"ironwood_fort_fill_4_15": {
    ...
    "name": "高堡西軍械封道",
    "zone": "ironwood_fort",
    "description": "高堡西軍械封道位在高堡西側牆道，西面指揮長廊仍有紅旗號令，南側內堡門影壓在石階上，北邊烽火信號塔的火盆忽明忽暗。東側臨時堆起鐵木拒馬、斷槍架與補給箱蓋，形成一道沉重軍械欄。地上散著油布、箭袋扣與被火星燒黑的繩結，牆面也留有急促搬運的刮痕。這裡像高堡臨戰時匆忙收束出的內側死角，仍保留可辨的軍械氣味與紅旗陰影。",
...
"glass_dunes_fill_4_18": {
    ...
    "name": "折光砂道",
    "zone": "glass_dunes",
    "description": "折光砂道位於北緣低丘間，陽光被一層層玻砂切成細碎白線，落在地上像無數短刃。南側沙海更亮，北方要塞聲音被熱浪吞沒，只剩模糊低影。道旁散有焦黑石片與被風磨圓的晶核，幾道舊車痕在砂面上忽斷忽續，最後停在過亮的硬殼前。每當雲影掠過，折光會短暫消退，露出砂下密集裂縫與空洞，說明此處只能作為辨認邊緣的地標。",
...
"glass_dunes_fill_5_18": {
    ...
    "name": "鏡砂邊坡",
    "zone": "glass_dunes",
    "description": "鏡砂邊坡貼著沙丘北側展開，玻化砂殼在腳下碎成細小亮片，往南能接入高熱沙脊，東西兩側則浮著稀薄折射光。坡下沒有完整木樁，只剩幾段被砂埋住的黑線與半截石標。北面傳來遠方要塞的悶聲，但聲音被熱浪壓得模糊，像隔著厚玻璃。坡面每隔一段便有細長裂縫，裂縫內反光更白，顯示硬殼下方空洞密布；只有靠南的暗砂帶還保存可辨方向。",
...
"glass_dunes_fill_6_18": {
    ...
    "name": "北砂亮線",
    "zone": "glass_dunes",
    "description": "北砂亮線在琉璃沙丘邊界拉出一道白色反光，南面沙丘像凝固浪脊，西側仍有要塞邊地的灰塵殘留。亮線由無數細小玻片排成，風過時會同時翻面，讓整片砂地忽然閃白。北側沒有路標，只有被熱浪扭曲的遠牆影；南側低處則浮著主沙路的暗色砂帶。幾處裂開的砂殼露出中空陰影，表示這條亮線並非道路，而是沙丘與外緣硬地斷裂後留下的光痕。",
...
"kingdom_frontier_fill_n10_n3": {
    ...
    "description": "南哨界碑封口立在王國邊境南側舊哨線旁，幾塊界碑半倒在草泥裡，表面徽記被刀痕與風沙磨得模糊。北面仍能看見殘哨臺的木影，南側低地則被拒馬、陷坑和倒塌石牆堵住。界碑間纏著褪色旗繩，繩下散著斷箭、巡邏牌與被雨水泡黑的皮帶。這片封口保留了早期防線的形狀，卻沒有可延伸的路，只剩一道把戰場推回北面的沉重痕跡。",
...
"kingdom_frontier_fill_n10_n4": {
    ...
    "name": "舊橡獵牆門",
    "zone": "kingdom_frontier",
    "description": "舊橡獵牆門位於邊境與王家獵場交界，東側古橡木群伸出濃密枝影，西面軍管草路留下舊哨旗和馬蹄痕。石門柱一半屬於獵場舊牆，一半被後來的軍用木樁加固，門楣上還掛著生鏽銅環。地面石板刻有狩獵徽紋，卻被補給車輪壓出新裂。兩邊旗繩顏色不同，風一吹便同時拉緊，像這道門一直夾在禮制獵場與邊境軍路之間。",
...
"kingdom_frontier_fill_n10_n5": {
    ...
    "name": "銀徑軍界口",
    "zone": "kingdom_frontier",
    "description": "銀徑軍界口接在銀葉獵徑西側，東面林下小路泛著淺銀葉光，西側邊境軍旗與低矮土牆壓住草坡。界口立著兩塊石碑，一塊刻王室獵令，一塊刻軍用通行符，碑腳被馬蹄和車輪反覆磨亮。草叢裡有斷羽、泥封和細小銅鈴，顯示此處常有巡哨與獵隊交錯停步。風穿過林口時帶來樹葉清香，也把更西側戰場的煙味一起拖入銀光小徑。",
...
"kingdom_frontier_fill_n10_n6": {
    ...
    "name": "邊境巡邏路",
    "zone": "kingdom_frontier",
    "description": "邊境巡邏路在獵場鹿徑西側延伸，西面是低牆與軍方哨旗，東側草叢裡可見王室與軍方並列的界標。路面狹窄而堅硬，軍靴印與鹿蹄印在泥裡交錯，只有一段較暗的石板穿過旗繩缺口。界碑旁立著舊警告牌，牌面被雨水洗到只剩輪廓。巡邏繩標沿草坡斷續前進，讓這條路看起來像被反覆放行又反覆收緊的邊境縫隙。",
...
"kingdom_frontier_fill_n10_n7": {
    ...
    "name": "號角獵門口",
    "zone": "kingdom_frontier",
    "description": "號角獵門口穿過王室獵場西側界碑，西面邊境巡邏路仍有軍靴印，東側獵角門掛著舊銅環與裂紋號角徽。門下石板刻著王室獵令，刻痕裡積著泥沙和細草根。兩側木樁分別綁著軍用繩標與獵場綠布，顏色在風中互相摩擦。門外能聞到遠方營火煙味，門內則傳來潮濕林葉氣息，兩種氣味在門檻處混成明確的跨境痕跡。",
...
"kingdom_frontier_fill_n11_n3": {
    ...
    "name": "南側殘哨臺",
    "zone": "kingdom_frontier",
    "description": "南側殘哨臺只剩半截木塔和斜倒的觀測欄，塔腳被荒草、舊盾牌與碎石包住。北方旗繩沿草坡延伸，南面舊界線後方堆著拒馬殘架，讓視野突然中斷。塔板上有被火燎過的腳印和幾道新近刀痕，旁邊散著空弩匣與斷哨鈴。風吹過殘臺時，木板會發出乾啞聲響，像早已廢棄的巡哨仍在提醒南側沒有穩定道路。",
...
"kingdom_frontier_fill_n13_n4": {
    ...
    "name": "中段旗繩封路",
    "zone": "kingdom_frontier",
    "description": "中段旗繩封路位在邊境草坡中線，兩排短木樁拉起褪色旗繩，繩後的泥路被倒塌拒馬和碎盾堵住。西北方可見舊牆哨影，東南面草坡通向較低巡路。地上車轍在旗繩前突然轉向，旁邊還有被踩碎的軍令牌和半截紅布。旗繩雖然簡陋，卻被反覆加固，木樁周圍的泥土被踏得很硬，顯示這裡曾多次阻止人馬向封線後方推進。",
...
"kingdom_frontier_fill_n14_n6": {
    ...
    "name": "鹿徑西拒馬",
    "zone": "kingdom_frontier",
    "description": "鹿徑西拒馬橫在王家獵場鹿徑西側，鐵包木拒馬被釘進泥地，尖端掛著斷羽和碎布。東面鹿徑的草色較亮，西側邊境巡路則滿是軍靴印和火盆灰。拒馬下方有鹿蹄在半途停住的痕跡，也有車輪試圖繞行後陷進濕泥的深槽。木樁旁的界牌被箭矢穿過，只剩徽紋外圈清晰，讓這處邊線同時帶著獵場的靜與軍管的硬。",
...
"kingdom_frontier_fill_n15_n7": {
    ...
    "name": "北角軍旗欄",
    "zone": "kingdom_frontier",
    "description": "北角軍旗欄立在獵場邊界北側轉角，一排軍旗木欄沿草坡彎過，旗布被雨和煙熏成暗色。南方可望見號角獵門口，西面戰場草路則散著斷箭與馬蹄印。木欄內側有幾只封存補給箱和空水桶，外側沒有清楚踏路，只剩被草蓋住的舊壕痕。旗桿頂端的鐵環互相碰撞，聲音很輕，卻足以把這個轉角標成巡線終點。",
...
"kingdom_frontier_fill_n17_n3": {
    ...
    "name": "西段舊牆哨",
    "zone": "kingdom_frontier",
    "description": "西段舊牆哨沿著邊境西北草牆殘段展開，矮牆由泥磚與粗石拼成，牆頭還留著幾個破哨孔。東南方旗繩封路若隱若現，西側荒草一直淹到牆根。牆邊散著腐朽箭筒、空火盆和被霜裂開的巡哨牌，牌上的日期已看不清。偶爾有風從牆孔穿過，帶出低低嘯聲，使這段牆像仍在把外圍荒地與可守的邊境草路分開。",
...
"kingdom_frontier_fill_n18_n4": {
    ...
    "name": "西北敵影牆",
    "zone": "kingdom_frontier",
    "description": "西北敵影牆是一段被加高又匆忙棄守的土石牆，牆外荒草深處常有影子被風推動，牆內則堆著斷槍、舊盾與散落旗釘。東側可見中段旗繩封路的紅布，南面西段舊牆哨沉在草坡後。牆面滿是箭孔與火燒黑痕，幾處新補泥層尚未完全乾硬。此地沒有通向牆外的階口，只有望孔和壓低的警戒視線，像一條把敵影留在外側的粗糙防線。",
...
"kingdom_frontier_fill_n18_n6": {
    ...
    "name": "西北荒草哨",
    "zone": "kingdom_frontier",
    "description": "西北荒草哨藏在高草與斷矛之間，只剩一圈低矮土臺、半塊火盆石和幾根斜倒旗桿。南面可望見北角軍旗欄的暗色旗布，東側草坡通往獵場邊界，西北方向則被荒草和舊陷坑吞沒。土臺上有被雨水沖淡的靴印，火盆裡混著灰、草籽和碎陶片。這處哨位不再承擔完整巡線，只像邊境最外緣的一個警覺殘點，默默標出荒草後方的不確定。",
...
"kingsroad_market_fill_23_2": {
    ...
    "description": "草藥棚北封街夾在守衛哨與草藥方場之間，石板路面被臨時木架、藥草箱和帆布雨棚占滿。北側可聽見衛兵亭銅鈴，東面草藥方場的苦香從箱縫滲出，南側主街人聲被棚布壓低。木架上掛著分類牌、乾燥草束與封好的陶瓶，地面則留有搬貨輪印。這片後勤角落用物資自然收住動線，讓草藥攤背面和市集通路分得很清楚。",
...
"kingsroad_market_fill_23_n1": {
    ...
    "name": "西北貨棚封巷",
    "zone": "kingsroad_market",
    "description": "西北貨棚封巷位在傳送廣場北面，南側石階傳來人潮腳步，東側井庭旁堆著水桶、布包和卸貨木架。貨棚帳繩橫過巷口，帆布下方塞滿木箱、空籃與繩網。牆邊有幾張被雨打濕的送貨牌，字跡順著木紋暈開。這條巷子像市集背面的暫存肺葉，保留補給與卸貨痕跡，卻被帳繩與貨堆自然收束在邊緣，連燈光也只停在箱角。",
...
"kingsroad_market_fill_25_5": {
    ...
    "name": "南市競技門廊",
    "zone": "kingsroad_market",
    "description": "南市競技門廊位於王道市集南緣，北面攤棚聲逐漸被石牆擋住，南側階梯接向競技城區的獎品櫃臺。門廊旁有票亭、舊賽程牌和幾面被陽光曬淡的三角旗，石地被觀賽人潮磨出寬痕。側門與貨車門被橫木鎖住，只留下通往南面的開闊階線。這裡帶著市集尾端的煙火氣，也帶著競技場入口的整齊秩序。",
...
"kingsroad_market_fill_26_3": {
    ...
    "name": "拍賣棚下封道",
    "zone": "kingsroad_market",
    "description": "拍賣棚下封道位於拍賣帳棚南側，北面帆布遮住木槌聲，東側高看台石階被繩欄和貨箱切開。地上留著車轍、搬運板痕與貨單木牌，幾個封蠟箱被疊在棚柱旁。帳棚背面陰影較深，油燈只照出一小片濕石。這條後勤道清楚顯示拍賣貨物流向，卻被搬運架與繩欄收窄成不能混入人潮的背面空間，木板縫裡還卡著碎蠟。",
...
"kingsroad_market_fill_26_n1": {
    ...
    "name": "鐵匠北貨欄",
    "zone": "kingsroad_market",
    "description": "鐵匠北貨欄貼著鍛匠列北面，南側爐火熱氣從石縫竄出，西面酒館招牌在棚影裡晃動。整排鐵料箱、冷卻水桶和未領貨牌鎖成臨時貨欄，鐵屑與煤灰堆在欄腳。幾把修到一半的門鉸掛在木梁上，仍帶著暗紅餘溫。這片貨欄標出鍛造區背面，讓爐火、領貨和市集通路彼此分開，也把熱鐵氣味困在狹窄陰影裡。",
...
"kingsroad_market_fill_28_3": {
    ...
    "name": "高陽台西封街",
    "zone": "kingsroad_market",
    "description": "高陽台西封街在市集東半部收窄，西側高看台的石欄與拱柱投下長影，北面帳冊後巷傳來紙頁聲，東側攤棚通道被布幕遮住。石街邊堆著空木箱、舊燈架與折起的遮雨棚骨，布幕下方可見攤位後場的暗影。地面車轍在此減淡，改成搬貨腳印和窄輪痕。這處封街像高看台下的服務褶皺，把觀市台、後巷和攤棚背面分隔開。",
