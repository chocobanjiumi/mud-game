...
"glass_dunes_fill_0_21": {
    ...
    "name": "日照西門",
    "zone": "glass_dunes",
    "description": "日照西門是一道低矮玻砂門檻，西側殘留紅岩荒地的乾熱氣味，東側日照玻門則把白光反射成一片刺眼牆面。門檻下有被砂磨平的石板與斷木樁，舊路往西不再連續，只留下幾段被流砂吞沒的暗線。東面門影較深，繩標與半埋石旗集中在那一側，顯示沙丘主路由此收束。風一吹，透明砂殼會發出細碎爆裂聲，像提醒邊緣地帶已經不屬於穩定荒原。",
