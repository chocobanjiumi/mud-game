...
"lakeside_town_fill_15_3": {
    ...
    "name": "城門北側酒館貨欄",
    "zone": "lakeside_town",
    "description": "城門北側酒館貨欄位在城門與酒館之間的背面角落，南側城門人流可聞，東面酒館牆後透出暖光。貨欄裡堆著酒桶、空杯箱和被雨水打濕的柴捆，木欄杆把狹窄空地收成後勤小院。地上只有搬桶留下的圓痕與幾道靴印，沒有主街的連續石路。酒香從木縫裡滲出，使這片角落清楚屬於酒館背面，而不是可穿越巷道。",
...
"lakeside_town_fill_15_5": {
    ...
    "name": "鐵匠鋪西補給石路",
    "zone": "lakeside_town",
    "description": "鐵匠鋪西補給石路貼著湖鐵鍛坊西牆，東面爐火熱氣從門縫裡吐出，西側商業街的石路被低矮貨架和煤袋壓窄。地上放著待修車輪、冷卻水桶與一捆捆鐵條，石縫裡積著黑灰。這段路保留補給車靠近鍛坊的痕跡，卻被物料自然收束成邊緣空地。爐聲很近，人潮卻被貨架隔開，只剩熱鐵氣味在石路上徘徊。",
...
"lakeside_town_fill_15_6": {
    ...
    "name": "聖門北側商巷界",
    "zone": "lakeside_town",
    "description": "聖門北側商巷界位在神殿外圍與商巷交會處，南面聖地門的白石階安靜發亮，東側靜望臺能看見湖面光影。路口立著小燈柱和磨平的捐獻石盒，旁邊攤棚逐漸退成低矮屋簷。青石從商街灰色轉為神殿白石，界線在腳下清楚可辨。香煙、湖風與遠處市聲在此交疊，使這段路像城鎮喧鬧走向靜處的緩坡。",
...
"lakeside_town_fill_16_1": {
    ...
    "name": "旅店北側神殿巷欄",
    "zone": "lakeside_town",
    "description": "旅店北側神殿巷欄夾在湖景旅店背面與神殿側廊之間，南面旅店窗燈溫暖，東側神殿白牆投下冷影。巷口放著修補欄杆、乾花籃和幾個待送洗的布包，石路被欄杆收窄成後勤側道。牆上有褪色客房牌與小祈願紙，風一吹便輕輕拍在白石上。這裡保留住宿與神殿之間的安靜過渡，卻沒有主路那樣的人流。",
...
"lakeside_town_fill_18_0": {
    ...
    "name": "法院東傳送補給坪",
    "zone": "lakeside_town",
    "description": "法院東傳送補給坪位在裁判所東側與傳送廣場外緣之間，西面灰白法院牆穩重，東側傳送陣藍光在地面拖出淡淡弧線。坪上堆著封存文書箱、守衛水袋和修補燈柱用的工具，石板比廣場邊緣更空。幾張濕掉的通告被壓在木板下，仍能看見湖畔印章。此處像公共建築之間的維修空地，把法令、守衛與傳送路線安靜連在一起。",
...
"lakeside_town_fill_18_5": {
    ...
    "name": "拍賣行南倉庫貨巷",
    "zone": "lakeside_town",
    "description": "拍賣行南倉庫貨巷位於拍賣場與湖港倉庫之間，北面紅棚投下暗影，南側倉庫木門散出潮濕麻袋味。窄巷裡堆著封蠟貨箱、空籠和搬運板，牆上掛著今日貨號與破損繩網。地面車輪痕在巷中突然轉向，顯示貨物只在後場流動。拍賣場的喧鬧隔著棚布變得模糊，巷內只剩木箱摩擦與水滴聲，牆角還留著幾枚未撕下的倉印。",
...
"lakeside_town_fill_18_6": {
    ...
    "name": "湖畔青石街",
    "zone": "lakeside_town",
    "description": "湖畔青石街是一段貼近水汽的窄街，西面月紋裁縫坊的藍布垂到門檐，東側湖鮮魚市的木桶與冰屑沿石路排開。青石表面被湖霧磨得發亮，腳邊排水溝流著淡淡魚鱗光。街旁有幾盞低燈、潮濕路牌和修補過的欄杆，欄外可聞到水堰細聲。這段街把柔軟布料、湖港魚貨與濕冷石路連在一起，是城鎮東側最有水味的通路。",
...
"lakeside_town_fill_19_3": {
    ...
    "name": "銀行北側監獄牆巷",
    "zone": "lakeside_town",
    "description": "銀行北側監獄牆巷貼著銀鱗銀行北牆延伸，南側厚石牆後是錢櫃，東面監獄外牆露出鐵窗陰影。巷中堆著封存木箱、舊鐵欄和幾卷潮濕麻布，地面沒有商街攤位，只留下守衛靴印。石牆吸住湖霧，使銅牌和鐵窗都泛著冷光。這條巷子像財務與羈押區之間的沉默縫隙，氣味乾冷，行人聲也被兩側厚牆吃掉。",
...
"plains_fill_7_2": {
    ...
    "name": "月林北麥田封坡",
    "zone": "plains",
    "description": "月林北麥田封坡靠在月影小林北側，南面樹影落進草地，東邊野兔洞穴周圍有翻土痕。麥田坡被舊籬笆切斷，是 邊界封閉點，用來封住小林與兔洞之間的外側空地。月林北麥田封坡周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
    "image": "plains_fill_7_2.png",
    "imagePrompt": "月林北麥田封坡 plains_fill_7_2 in plains 翠綠平原, room function danger pocket, terrain open grassy plain path, wheat edges, wind-bent grass, low fences, clear sky breaks and warm field light, visible path cues: north south east west nearby landmarks implied by sealed boundary and adjacent map roads, source room details: 月林北麥田封坡靠在月影小林北側，南面樹影落進草地，東邊野兔洞穴周圍有翻土痕。麥田坡被舊籬笆切斷，是 border blocker，用來封住小林與兔洞之間的外側空地。, low wilds connector, open grass and readable travel direction, slightly elevated adventurer eye view, clear foreground walking space, readable midground landmark, deep background silhouette, tactile terrain and architecture materials, dark fantasy painterly environment illustration, vertical 10:16, consistent style, no UI, no text",
    "exits": [],
    "mapSymbol": "[·]",
    "mapX": 0,
    "mapY": 2,
