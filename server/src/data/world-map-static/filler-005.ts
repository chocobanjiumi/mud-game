...
"starter_village_fill_1_3": {
    ...
    "description": "溪階傳送低地小徑鋪著潮濕青石板，西面溪畔石階能聽見水聲，東側傳送祠堂透出藍光，兩旁低木柵隔開民宅菜圃。這裡是安全 路線，專門銜接新手村低地服務點。溪階傳送低地小徑周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"starter_village_fill_3_4": {
    ...
    "name": "市場北後勤青石巷",
    "zone": "starter_village",
    "description": "市場北後勤青石巷位在村莊服務區後方，北面公告角落與水井小路人聲清楚，南側市場小巷飄來麵包與藥草味。平坦石路只留給村民搬貨，是安全 service 封閉點，不開新路。市場北後勤青石巷周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"starter_village_fill_5_3": {
    ...
    "name": "守衛哨西民宅木柵",
    "zone": "starter_village",
    "description": "守衛哨西民宅木柵位在新手村東側民宅旁，西面馬廄院的木門半掩，北邊守衛哨所可見火把。青石板到此被低矮木柵截斷，只作村內 封閉點，避免玩家穿進住戶院落。守衛哨西民宅木柵周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"storm_highlands_fill_n10_n14": {
    ...
    "description": "獅鷲王峰東雷崖封位在風暴高原東緣，西側可望見獅鷲王峰的黑影與狂風眼，南面雷雲沿斷崖翻滾，東方只剩碎裂岩柱。雷擊岩臺上有焦黑石徑與風暴羽殘片，但外側岩柱全被劈斷，這裡是 邊界封閉點，明確封住外側路線不提供通行。獅鷲王峰東雷崖封周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"storm_highlands_fill_n11_n13": {
    ...
    "name": "天石堆東斷崖封",
    "zone": "storm_highlands",
    "description": "天石堆東斷崖封貼著高原北側碎崖，西面天石堆的石 cairn 被雨水磨亮，南側獅鷲王峰傳來長鳴。碎石道路在東邊斷成空谷，岩臺邊插著折斷風旗、警戒石柱與濕滑鐵環，雷風會把人推離崖面，不可久站，是封路 封閉點。天石堆東斷崖封周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"storm_highlands_fill_n11_n15": {
    ...
    "name": "風暴玻礦東封脊",
    "zone": "storm_highlands",
    "description": "風暴玻礦東封脊位在高原南北風線交會處，西面風暴玻礦脈閃著藍白裂光，南側獅鷲王峰被雲牆遮住。岩脊石徑上露出可採碎玻礦屑與裂晶粉，採集只能在礦脈內側完成；東北風把外側削成危險斷口，是 封閉點。風暴玻礦東封脊周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"storm_highlands_fill_n17_n15": {
    ...
    "name": "避風村南斷崖徑",
    "zone": "storm_highlands",
    "description": "避風村南斷崖徑從北側補給棚下到高原主路，南面風切小徑與峭壁入口的雲霧相連，東邊玄武岩脊擋住橫風。這裡只作村界下坡與 封閉點，提醒玩家離開安全補給區。避風村南斷崖徑周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_11_22": {
    ...
    "name": "滾雷門北封草",
    "zone": "thundersteppe",
    "description": "滾雷門北封草在草原西北側隆起，南面滾雷門的木樁仍有焦黑痕，東面野豬奔道被長草遮住。雷雲壓低後草尖放電，這裡是封閉邊界，不提供通行或採集互動。滾雷門北封草周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_12_21": {
    ...
    "name": "雨影西北焦痕",
    "zone": "thundersteppe",
    "description": "雨影西北焦痕貼著野豬奔道北側，南面草叢道路被踩成泥線，東側雨影溝的乾風切過草面。焦土裡有雷擊草灰採集點，但裂縫太密，這裡是採集邊界，不能繼續穿越。雨影西北焦痕周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_12_25": {
    ...
    "name": "風祠北崖焦草",
    "zone": "thundersteppe",
    "description": "風祠北崖焦草在風祭小祠西北方抬高，北側鷹巢棲木露出崖影，西面小祠旗繩仍能聽見。焦草根部有可採雷種與羽片，但崖面斷裂，這裡是採集邊界。風祠北崖焦草周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_14_21": {
    ...
    "name": "月沼南雷封界",
    "zone": "thundersteppe",
    "description": "月沼南雷封界位於雷鳴草原北緣，北面月光濕地的深水霧氣被雷風推回，南側狼崖草線變得焦黑，西面雨影溝聲音低沉。這裡是邊界封鎖，雷溝斷開濕地與草原，不開新路。月沼南雷封界周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_14_25": {
    ...
    "name": "雷針南封草場",
    "zone": "thundersteppe",
    "description": "雷針南封草場在避雷針田南側展開，北面鐵針尖端仍有藍火跳動，東面鷹巢峰的岩影壓到草坡。草場中央被雷擊成黑圈，這格是封閉邊界，不安排採集或戰鬥。雷針南封草場周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_15_24": {
    ...
    "name": "天火台西南焦坡",
    "zone": "thundersteppe",
    "description": "天火台西南焦坡位於天火台南側，北面石台仍冒著熱氣，西側避雷針田的鐵影排列成線，南面鷹巢峰草坡更陡。焦土邊有雷擊草灰採集點，這裡是採集邊界。天火台西南焦坡周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_17_22": {
    ...
    "name": "雷龍風眼西封痕",
    "zone": "thundersteppe",
    "description": "雷龍風眼西封痕貼近雷龍風眼北側，南面草面被旋風壓成圓環，西側雷蹄渡口的泥線斷在焦土前。黑草根能採到少量雷灰，但風壓阻斷道路，這裡是採集邊界。雷龍風眼西封痕周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_20_22": {
    ...
    "name": "灰門西雷草坡",
    "zone": "thundersteppe",
    "description": "灰門西雷草坡位於雷鳴草原東北界，南側東界雷路通往燒焦哨站，東面餘燼邊境灰門冒出熱風。草坡上有雷草與灰燼種子採集點，這裡是邊界採集通路，銜接草原與焦土邊界。灰門西雷草坡周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_20_23": {
    ...
    "name": "東界燒哨雷路",
    "zone": "thundersteppe",
    "description": "東界燒哨雷路是雷鳴草原通往餘燼邊境的主邊界，北側灰門草坡仍有雷草，南面玻灰草地泛著紅光，東側燒焦哨站旗杆冒煙。這裡是邊界通路，西側雷溝封住回切草原內圈。東界燒哨雷路周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"thundersteppe_fill_20_24": {
    ...
    "name": "玻灰東界草地",
    "zone": "thundersteppe",
    "description": "玻灰東界草地位於雷鳴草原東南界，北面燒哨雷路有焦旗煙，東側餘燼邊境的玻灰原反射紅光。草坡裡有雷草與玻灰碎片採集點，這裡是邊界採集通路，標示兩區地貌交界與採集邊界。玻灰東界草地周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"volcano_zone_fill_31_22": {
    ...
    "name": "火山邊道",
    "zone": "volcano_zone",
    "description": "火山灰原南側的灰燼邊道夾在黑色灰丘與硫磺熱霧之間，腳下可見被熱風燒裂的玄武岩。北面回火山灰原，南側熱氣逐漸變黃並接往硫磺熱泉，路旁噴氣孔會提醒玩家放慢腳步觀察噴發節奏。火山邊道周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"volcano_zone_fill_32_25": {
    ...
    "name": "火山石路",
    "zone": "volcano_zone",
    "description": "玄武岩階東側的火山石路沿著山巔封印鏈外圈延伸，黑石地面被熔岩光照成暗紅。西面回玄武岩階，東側能看到火山頂的開闊岩脊，路旁裂縫會噴出短促熱風，適合玩家先判斷落腳點再推進。火山石路周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"volcano_zone_fill_34_24": {
    ...
    "name": "火晶噴口西封岩",
    "zone": "volcano_zone",
    "description": "火晶噴口西封岩位在火晶噴氣口西側，西面熔岩橋熱光斷續閃爍，南側玄武岩階通往火山石路。腳下岩縫定時噴出高溫白汽，這裡是 封閉點，封住通往噴口背面的不穩石路。火晶噴口西封岩周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n3_8": {
    ...
    "description": "舊祠南霧池封徑位在舊祠南側，北面祠柱被苔痕覆住，西邊霧池白氣沿蘆葦根滑來。濕泥把石板吞成斷面，是 邊界封閉點，用來封住舊祠與霧池之間的外側谷底。舊祠南霧池封徑周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n4_6": {
    ...
    "name": "冷泉南石板封",
    "zone": "whispering_valley",
    "description": "冷泉南石板封位在冷泉南側，北面泉水沿石縫結成薄霜，東邊柳樹營地掛著低垂布條，西側釣彎水聲貼著谷壁迴盪。這裡是純 封閉點，濕滑石板被倒柳根截斷。冷泉南石板封周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n4_7": {
    ...
    "name": "霧池北蘆根封地",
    "zone": "whispering_valley",
    "description": "霧池北蘆根封地夾在冷泉南石板封與霧池之間，東側舊祠低牆露出青苔，西邊藥草坡有採集繩樁。蘆根糾結成濕泥牆，是 封閉點 邊界，提醒玩家沿正式谷道繞行。霧池北蘆根封地周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n4_9": {
    ...
    "name": "霧池南冰蕨封石",
    "zone": "whispering_valley",
    "description": "霧池南冰蕨封石位在霧池南側，北面霧水不斷漫上石板，西側冰蕨叢發出冷白光。谷底石路在這裡被濕滑苔面截斷，是純 封閉點，不作南向通行路線。霧池南冰蕨封石周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n5_11": {
    ...
    "name": "古樹屋北瀑蘆界",
    "zone": "whispering_valley",
    "description": "古樹屋北瀑蘆界位在低語溪谷南緣，北面隱瀑水聲落進霧裡，南方古樹屋的樹根探入谷底，西側低語裂隙傳來空洞回音。這裡是邊界採集 封閉點，蘆根可採集，但不開往樹屋捷徑。古樹屋北瀑蘆界周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n6_10": {
    ...
    "name": "裂隙北瀑霧封",
    "zone": "whispering_valley",
    "description": "裂隙北瀑霧封位在低語裂隙北側，北面瀑布底部水聲壓過風語，東側隱瀑白霧沿石壁滑下。這裡是採集 封閉點，濕石邊可採霧苔與冷蕨，但裂縫阻止繼續穿越。裂隙北瀑霧封周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n7_11": {
    ...
    "name": "螢火小徑北蘆草界",
    "zone": "whispering_valley",
    "description": "螢火小徑北蘆草界位在低語溪谷西南緣，東面低語裂隙仍有回聲，南方螢火小徑閃著細小綠光。蘆葦草根把谷底泥道收成單線，這裡是跨區邊界採集路線端點，專門銜接溪谷與螢火路。螢火小徑北蘆草界周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n7_6": {
    ...
    "name": "谷底通道",
    "zone": "whispering_valley",
    "description": "谷底通道位在巡林哨站南側，濕滑石板沿溪谷低處延伸，牆上還留著巡林人用炭筆補上的箭頭。北面回哨站，南面接蘆葦路，玩家可依水聲和舊路標判斷石堰方向。谷底通道周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"whispering_valley_fill_n7_7": {
    ...
    "name": "蘆葦路",
    "zone": "whispering_valley",
    "description": "蘆葦路夾在谷底通道與石堰之間，兩側水草被溪風吹得貼向石板，像有人在耳邊低語。北面回谷底通道，南側可抵石堰，玩家可從蘆葦倒伏方向辨認水流與狼群足跡。蘆葦路周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_1_n10": {
    ...
    "description": "西界隱泉草封坡卡在防風柵門南側，乾草與碎石堆成低牆，北望能見風柵木影，南面接回隱泉濕草，東側則貼著彎橡坡。這裡只保留採集風乾草籽的窄面，沒有可繼續通行的正式道路。西界隱泉草封坡周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_1_n8": {
    ...
    "name": "斷圖騰西封徑",
    "zone": "wildgrass_hills",
    "description": "斷圖騰西封徑是一段被高草吞沒的短坡，北側回到隱泉邊緣，東面隔著風磨碎石可看見斷圖騰的陰影。坡脊被倒伏草根封住，適合標記野草丘陵邊界，不作為主要通道使用。斷圖騰西封徑周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_2_n12": {
    ...
    "name": "舊路溪切風口",
    "zone": "wildgrass_hills",
    "description": "舊路溪切風口是野草丘陵北線的正式 路線，西邊的舊路切口在草浪中露出硬土，東邊溪切溝傳來碎水聲，南側低坡可作方位參照。強風穿過凹口，把往返舊路與溪溝的腳印吹得斷續卻仍可辨認。舊路溪切風口周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_2_n7": {
    ...
    "name": "村溪北界草欄",
    "zone": "wildgrass_hills",
    "description": "村溪北界草欄立在野草丘陵與村溪之間，北側高坡通向斷圖騰附近，南面可聽見村溪水聲但被草欄與警示樁隔開。這裡是邊界 封閉點，用來阻止丘陵路線誤接回新手村後側。村溪北界草欄周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_3_n8": {
    ...
    "name": "圖騰東採草坡",
    "zone": "wildgrass_hills",
    "description": "圖騰東採草坡承接斷圖騰東側的草路，北邊石環露出半圈灰白石尖，東面坡線續往斷旗中央，草叢中混著可採的硬莖風草。這段同時是往風暴草冠的 路線，也提供低風險採集點。圖騰東採草坡周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_4_n12": {
    ...
    "name": "溪切東側豬泥坡",
    "zone": "wildgrass_hills",
    "description": "溪切東側豬泥坡夾在溪切溝與野豬泥潭之間，西側濕石帶著溪水青苔，南面泥地被野豬踏出深坑。坡上長著可採的苦葉草，但泥坑與亂石封住外緣，只能作採集 封閉點 與地形邊界。溪切東側豬泥坡周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_4_n8": {
    ...
    "name": "斷旗中央坡道",
    "zone": "wildgrass_hills",
    "description": "斷旗中央坡道是圖騰草坡與風暴草冠之間的純路線 路線，北側雷丘高起，破旗桿在風裡發出空響。坡面被踩出穩定土階，西行能回到圖騰東採草坡，東行則接向風冠西坡小徑。斷旗中央坡道周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_5_n8": {
    ...
    "name": "風冠西坡小徑",
    "zone": "wildgrass_hills",
    "description": "風冠西坡小徑沿著風暴草冠西側展開，北方首領脊線像黑齒般壓在天邊，東面草冠在風中翻起銀綠色浪脊。低草土階與倒旗石牌標出安全路面，這裡是純路線 路線，負責把斷旗中央坡道穩定接入風暴草冠核心。風冠西坡小徑周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
...
"wildgrass_hills_fill_6_n9": {
    ...
    "name": "風車南採草坡",
    "zone": "wildgrass_hills",
    "description": "風車南採草坡位在破風車殼下方，北面能看見殘葉輪，南側接近風暴草冠，西邊則有首領脊線作為明顯地標。坡上散著可採的風鳴草、乾籽穗與斷裂草繩，採集點集中在木樁旁；外側草根糾結封住坡線，只作採集 封閉點。風車南採草坡周邊的路面、植被、舊標記與相鄰地貌都需要被看清，北南東西的可行方向、封閉邊線與回程線索會在場景中自然呈現，讓隊伍能判斷是否採集、折返或接回主路。",
