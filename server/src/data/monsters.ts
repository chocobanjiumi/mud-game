...
export const MONSTERS: Record<string, MonsterDef> = {
  ...
  bandit: {
    ...
    goldReward: [15, 30],
    drops: [
      { itemId: 'bandit_blade', chance: 0.1, minQty: 1, maxQty: 1 },
  ...
  crystal_guardian: {
    ...
    drops: [
      ...
      { itemId: 'crystal_sword', chance: 0.08, minQty: 1, maxQty: 1 },
    ],
    aiType: 'boss',
    description:
  ...
  creek_mossling_slime: {
    id: 'creek_mossling_slime',
    name: '溪苔史萊姆',
    alias: 'mossling',
    level: 3,
    hp: 42,
    ...
    goldReward: [3, 8],
    drops: [
      { itemId: 'hillside_moss_jelly', chance: 0.45, minQty: 1, maxQty: 2 },
      { itemId: 'creek_reed_splint', chance: 0.22, minQty: 1, maxQty: 1 },
      { itemId: 'herb', chance: 0.12, minQty: 1, maxQty: 1 },
    ],
    aiType: 'passive',
    description: '長著細小苔斑的溪邊史萊姆，身體裡漂著蘆葦碎屑和圓滑小石。牠會貼著水邊緩慢移動，吸收露水與草根汁液，受到驚嚇時才用濕滑身體撞向靠近者。',
    isBoss: false,
    guardianHints: {
      creature: '溪苔史萊姆會躲在蘆葦根旁，水面冒出連續小泡時通常就在附近。',
      treasure: '牠體內的山坡苔膠和溪蘆碎屑能製成村醫常用的外傷藥。',
      spirit: '牠像是後山清水與草地魔力自然混成的小生命，清理時不會破壞區域生態。',
    },
  },

  orchard_sharpbeak_crow: {
    id: 'orchard_sharpbeak_crow',
    name: '啄果利喙鴉',
    alias: 'sharpbeak',
    level: 4,
    hp: 48,
    ...
    element: 'dark',
    family: 'beast',
    skills: ['basic_attack', 'screech', 'quick_dash'],
    expReward: 24,
    goldReward: [4, 10],
    drops: [
      { itemId: 'orchard_waxcomb', chance: 0.28, minQty: 1, maxQty: 1 },
      { itemId: 'willow_prayer_tag', chance: 0.08, minQty: 1, maxQty: 1 },
      { itemId: 'small_mp_potion', chance: 0.08, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '棲在果園和柳樹神龕之間的黑羽烏鴉，鳥喙被果核磨得又尖又亮。牠會啄破蜂巢偷食蜂蠟，也會把閃亮木牌和紅線拖回巢裡，從樹梢俯衝騷擾調查者。',
    isBoss: false,
    guardianHints: {
      creature: '利喙鴉俯衝前會先在枝頭左右跳動，聽到連續短鳴就該抬盾。',
      treasure: '牠的巢裡常混著果園蜂蠟、祈願木牌與被偷走的小銅幣。',
      spirit: '牠們受到墓地方向的陰氣影響，比普通果園烏鴉更愛收集與失蹤傳聞有關的物件。',
    },
  },
  ...
  hollow_stump_hoarder: {
    id: 'hollow_stump_hoarder',
    name: '空樹屯糧鼠',
    alias: 'hoarder',
    level: 6,
    hp: 150,
    ...
    goldReward: [18, 36],
    drops: [
      { itemId: 'stolen_pouch', chance: 0.45, minQty: 1, maxQty: 1 },
      { itemId: 'broken_bridge_rope', chance: 0.3, minQty: 1, maxQty: 2 },
      { itemId: 'willow_prayer_tag', chance: 0.18, minQty: 1, maxQty: 1 },
      { itemId: 'village_herb_salve', chance: 0.1, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '佔據空心樹樁根道的肥大田鼠，背上綁著從村外偷來的布條、繩結和小袋。牠會把同伴趕進狹窄根洞伏擊旅人，再趁混亂叼走藥包與祈願牌。',
    isBoss: false,
    isElite: true,
    respawnTime: 600,
    guardianHints: {
      creature: '屯糧鼠會先派普通田鼠騷擾，再從樹根背面衝出偷取補給。',
      treasure: '牠的根洞裡堆著斷橋粗繩、贓物袋和被咬破的柳木祈願牌。',
      spirit: '牠不是邪物，只是被村外混亂餵大的害獸；擊退牠能讓根窖與空樹路線安全許多。',
    },
  },
  ...
  sea_crab: {
    ...
    goldReward: [8, 16],
    drops: [
      { itemId: 'salt_crab_shell', chance: 0.42, minQty: 1, maxQty: 2 },
      { itemId: 'crystal_shard', chance: 0.12, minQty: 1, maxQty: 1 },
      { itemId: 'small_hp_potion', chance: 0.15, minQty: 1, maxQty: 1 },
    ],
    aiType: 'defensive',
  ...
  jellyfish: {
    ...
    goldReward: [9, 17],
    drops: [
      { itemId: 'moon_jelly_lantern', chance: 0.36, minQty: 1, maxQty: 1 },
      { itemId: 'slime_jelly', chance: 0.22, minQty: 1, maxQty: 2 },
  ...
  storm_gull: {
    ...
    goldReward: [10, 22],
    drops: [
      { itemId: 'kelp_rope_coil', chance: 0.24, minQty: 1, maxQty: 1 },
      { itemId: 'small_mp_potion', chance: 0.12, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '在燈塔與觀潮斷崖附近盤旋的大型海鷗，羽尖帶著暴風前的灰藍電光。牠會沿著強風滑翔，再用尖叫與俯衝把旅人逼向濕滑崖邊。',
    isBoss: false,
    guardianHints: {
      creature: '暴風海鷗通常逆風懸停，牠突然收翼時代表即將俯衝。',
      treasure: '牠會把海藻繩、玻璃片和漁鉤拖回高處巢穴。',
      spirit: '漁民把牠視為暴風預兆；牠出現時，遠海通常已有雷雲成形。',
    },
  },

  reefback_crab_guard: {
    id: 'reefback_crab_guard',
    name: '礁背蟹衛',
    alias: 'reefcrab',
    level: 10,
    hp: 260,
    ...
    element: 'ice',
    family: 'aquatic',
    skills: ['basic_attack', 'shell_guard', 'stone_slam'],
    expReward: 120,
    goldReward: [28, 55],
    drops: [
      { itemId: 'salt_crab_shell', chance: 0.8, minQty: 2, maxQty: 3 },
      { itemId: 'tidewatch_pearl', chance: 0.16, minQty: 1, maxQty: 1 },
      { itemId: 'medium_hp_potion', chance: 0.18, minQty: 1, maxQty: 1 },
    ],
    aiType: 'defensive',
    description: '背殼長滿小礁石與藤壺的巨蟹，常守在潮池岩穴和斷裂棧橋下方。牠平時像一塊濕黑礁石，受到驚動時才展開厚重螯鉗封住狹窄通道。',
    isBoss: false,
    isElite: true,
    respawnTime: 900,
    guardianHints: {
      creature: '礁背蟹衛會用背殼堵路，先清理周圍海蟹再集中攻擊較安全。',
      treasure: '牠殼縫裡常卡著觀潮珍珠與被海水磨亮的小物。',
      spirit: '牠像是潮池自己的守門者，保護退潮後暴露的珍珠床與岩穴。',
    },
  },
  ...
  pirate: {
    ...
    drops: [
      ...
      { itemId: 'bandit_blade', chance: 0.08, minQty: 1, maxQty: 1 },
  ...
  sea_serpent: {
    ...
    goldReward: [15, 30],
    drops: [
      { itemId: 'snake_venom', chance: 0.25, minQty: 1, maxQty: 2 },
      { itemId: 'snake_skin', chance: 0.3, minQty: 1, maxQty: 1 },
      { itemId: 'tidewatch_pearl', chance: 0.1, minQty: 1, maxQty: 1 },
      { itemId: 'antidote', chance: 0.2, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
  ...
  tidepool_murk_eel: {
    ...
    element: 'ice',
    family: 'aquatic',
    skills: ['basic_attack', 'poison_bite', 'quick_dash'],
    expReward: 70,
    goldReward: [18, 36],
    drops: [
      { itemId: 'kelp_rope_coil', chance: 0.3, minQty: 1, maxQty: 2 },
      { itemId: 'moon_jelly_lantern', chance: 0.16, minQty: 1, maxQty: 1 },
      { itemId: 'antidote', chance: 0.16, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '躲在潮池裂縫和海底洞穴泥沙中的長鰻，灰藍身體能與海藻陰影融在一起。牠會纏住腳踝拖向深水，再用帶麻痺感的咬擊阻止獵物逃上岸。',
    isBoss: false,
    guardianHints: {
      creature: '泥鰻藏身處會有海藻繩般的陰影逆著水流擺動。',
      treasure: '牠常把水母燈囊和海藻繩卷拖進裂縫築巢。',
      spirit: '牠們是潮汐裂縫的伏擊者，讓東方海岸的淺水探索不只是海蟹與海蛇。',
    },
  },
  ...
  fire_salamander: {
    ...
    goldReward: [20, 40],
    drops: [
      { itemId: 'salamander_tail', chance: 0.38, minQty: 1, maxQty: 1 },
      { itemId: 'sulfur_crystal_cluster', chance: 0.18, minQty: 1, maxQty: 1 },
      { itemId: 'medium_hp_potion', chance: 0.15, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
  ...
  rock_giant: {
    ...
    goldReward: [28, 55],
    drops: [
      { itemId: 'obsidian_glass_plate', chance: 0.35, minQty: 1, maxQty: 2 },
  ...
  flame_spirit: {
    ...
    goldReward: [30, 55],
    drops: [
      { itemId: 'fire_vent_crystal', chance: 0.32, minQty: 1, maxQty: 1 },
      { itemId: 'sulfur_crystal_cluster', chance: 0.2, minQty: 1, maxQty: 1 },
  ...
  lava_worm: {
    ...
    goldReward: [32, 60],
    drops: [
      { itemId: 'lava_fragment', chance: 0.4, minQty: 1, maxQty: 2 },
      { itemId: 'sulfur_crystal_cluster', chance: 0.22, minQty: 1, maxQty: 1 },
  ...
  dwarf_guard: {
    ...
    drops: [
      ...
      { itemId: 'obsidian_glass_plate', chance: 0.25, minQty: 1, maxQty: 1 },
      { itemId: 'forge_calibration_tongs', chance: 0.08, minQty: 1, maxQty: 1 },
  ...
  snow_wolf: {
    ...
    goldReward: [30, 60],
    drops: [
      { itemId: 'snowwolf_fur', chance: 0.42, minQty: 1, maxQty: 2 },
      { itemId: 'wolf_fang', chance: 0.25, minQty: 1, maxQty: 2 },
      { itemId: 'large_hp_potion', chance: 0.12, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
  ...
  ice_elemental: {
    ...
    drops: [
      ...
      { itemId: 'glacier_fossil_shard', chance: 0.22, minQty: 1, maxQty: 1 },
  ...
  frost_giant: {
    ...
    drops: [
      ...
      { itemId: 'glacier_fossil_shard', chance: 0.28, minQty: 1, maxQty: 2 },
  ...
  yeti: {
    ...
    goldReward: [55, 110],
    drops: [
      { itemId: 'snowwolf_fur', chance: 0.28, minQty: 1, maxQty: 2 },
      { itemId: 'frostpine_resin', chance: 0.22, minQty: 1, maxQty: 1 },
  ...
  frostpine_stalker: {
    ...
    goldReward: [34, 68],
    drops: [
      { itemId: 'snowwolf_fur', chance: 0.45, minQty: 1, maxQty: 2 },
      { itemId: 'frostpine_resin', chance: 0.22, minQty: 1, maxQty: 1 },
      { itemId: 'large_hp_potion', chance: 0.1, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '在霜松林與積雪隘口間伏擊獵物的長腿雪狼，毛色混著松針般的藍綠暗紋。牠會貼著樹影繞到隊伍後方，以低嚎引導狼群包抄。',
    isBoss: false,
    guardianHints: {
      creature: '霜松潛獵者會先踩斷覆雪松枝，若聽見清脆斷裂聲就代表牠在繞背。',
      treasure: '牠身上的雪狼毛和霜松樹脂常黏在一起，是防風斗篷的好材料。',
      spirit: '牠把霜松林、營地與狼巢連成一條狩獵路線，讓雪原不只是開闊白地。',
    },
  },

  glacier_bone_wraith: {
    id: 'glacier_bone_wraith',
    name: '冰河骨魄',
    alias: 'bonewraith',
    level: 25,
    hp: 360,
    ...
    element: 'ice',
    family: 'undead',
    skills: ['basic_attack', 'frost_nova', 'ice_armor', 'death_mark'],
    expReward: 185,
    goldReward: [44, 88],
    drops: [
      { itemId: 'glacier_fossil_shard', chance: 0.45, minQty: 1, maxQty: 2 },
      { itemId: 'ice_crystal', chance: 0.24, minQty: 1, maxQty: 2 },
      { itemId: 'large_mp_potion', chance: 0.12, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '從冰河裂縫古代獸骨中浮出的蒼白怨魄，身形像被冰包住的骨架影子。牠會用寒氣拖慢旅人腳步，再把破碎化石片捲成鋒利冰刃。',
    isBoss: false,
    guardianHints: {
      creature: '冰河骨魄現身前，冰壁裡的化石會一起轉向隊伍。',
      treasure: '牠消散後常留下能解讀古代災變的冰河化石片。',
      spirit: '牠們是冰河記憶的殘響，讓裂縫與冰釣洞具有考古與亡靈層次。',
    },
  },

  royal_frost_guard: {
    id: 'royal_frost_guard',
    name: '王朝霜衛',
    alias: 'frostguard',
    level: 28,
    hp: 780,
    ...
    element: 'ice',
    family: 'humanoid',
    skills: ['basic_attack', 'stone_slam', 'ice_armor', 'frost_nova', 'howl'],
    expReward: 310,
    goldReward: [90, 180],
    drops: [
      { itemId: 'frozen_watch_badge', chance: 0.36, minQty: 1, maxQty: 1 },
      { itemId: 'aurora_runestone_chip', chance: 0.28, minQty: 1, maxQty: 1 },
      { itemId: 'ice_crystal', chance: 0.35, minQty: 1, maxQty: 2 },
    ],
    aiType: 'defensive',
    description: '冰之王國禁衛軍被龍息凍結後留下的行走鎧甲，胸甲仍掛著半透明王朝徽章。牠們巡守結冰哨塔與城堡大門，不辨活人與侵略者，只執行最後命令。',
    isBoss: false,
    isElite: true,
    respawnTime: 1200,
    guardianHints: {
      creature: '王朝霜衛舉盾時會先踏出固定巡邏步，打亂步伐可讓牠短暫失衡。',
      treasure: '牠胸前的冰哨徽章記錄城門、符石環與哨塔的巡邏順序。',
      spirit: '牠們不是單純怪物，而是冰之王國最後命令殘留的士兵。',
    },
  },
  ...
  ice_dragon_whelp: {
    ...
    drops: [
      ...
      { itemId: 'aurora_runestone_chip', chance: 0.4, minQty: 1, maxQty: 2 },
  ...
  ash_cinder_imp: {
    ...
    goldReward: [22, 44],
    drops: [
      { itemId: 'lava_fragment', chance: 0.28, minQty: 1, maxQty: 1 },
      { itemId: 'fire_vent_crystal', chance: 0.18, minQty: 1, maxQty: 1 },
      { itemId: 'medium_mp_potion', chance: 0.12, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '從火山灰丘與熔爐風口中跳出的煤黑小精怪，身體像半燃的木炭，奔跑時會沿路掉落火星。牠們會鑽進工具箱或礦車裡惡作劇，受到追趕時噴出刺眼灰燼。',
    isBoss: false,
    guardianHints: {
      creature: '灰燼煤精會先躲進黑灰堆，灰丘表面突然冒出藍火就是牠準備衝出的徵兆。',
      treasure: '牠們常偷走火晶種與小型爐具零件，用來堆自己的灰燼巢。',
      spirit: '牠們像爐火情緒的碎片，火山越躁動，煤精越愛在外層通道出沒。',
    },
  },

  sulfur_steam_crawler: {
    id: 'sulfur_steam_crawler',
    name: '硫煙爬蟲',
    alias: 'sulfurcrawler',
    level: 18,
    hp: 210,
    ...
    element: 'fire',
    family: 'insect',
    skills: ['basic_attack', 'poison_spit', 'fire_breath'],
    expReward: 108,
    goldReward: [28, 54],
    drops: [
      { itemId: 'sulfur_crystal_cluster', chance: 0.46, minQty: 1, maxQty: 2 },
      { itemId: 'heatproof_miner_salve', chance: 0.08, minQty: 1, maxQty: 1 },
      { itemId: 'antidote', chance: 0.16, minQty: 1, maxQty: 1 },
    ],
    aiType: 'aggressive',
    description: '棲在硫磺熱泉與毒霧裂縫中的黃殼爬蟲，背甲長滿硫磺晶刺。牠會趴在沸騰池邊吸收蒸汽，再把帶毒熱霧噴向靠近採集晶簇的人。',
    isBoss: false,
    guardianHints: {
      creature: '硫煙爬蟲出現前，熱泉泡泡會變成刺鼻的黃綠色。',
      treasure: '牠背上的晶刺是硫磺晶簇品質最穩定的來源。',
      spirit: '牠們維持火山排氣口的毒霧循環，是危險但合理的硫磺生態節點。',
    },
  },

  basalt_ward_sentinel: {
    id: 'basalt_ward_sentinel',
    name: '玄武岩鎮衛',
    alias: 'basaltsentinel',
    level: 21,
    hp: 620,
    mp: 35,
    str: 36,
    ...
    element: 'none',
    family: 'construct',
    skills: ['basic_attack', 'stone_slam', 'stone_skin', 'bark_shield'],
    expReward: 220,
    goldReward: [60, 120],
    drops: [
      { itemId: 'obsidian_glass_plate', chance: 0.55, minQty: 2, maxQty: 3 },
      { itemId: 'forge_calibration_tongs', chance: 0.2, minQty: 1, maxQty: 1 },
      { itemId: 'stone_heart', chance: 0.25, minQty: 1, maxQty: 1 },
    ],
    aiType: 'defensive',
    description: '矮人祖先刻在玄武岩階與神殿門外的鎮守石像，平時像黑色路標，封印鬆動時才會拔出石臂。牠的胸口嵌著校爐刻度板，會阻止未授權者靠近核心熔爐。',
    isBoss: false,
    isElite: true,
    respawnTime: 1200,
    guardianHints: {
      creature: '玄武岩鎮衛舉臂前胸口刻度會亮起，趁亮光轉紅前拉開距離。',
      treasure: '牠胸口的刻度板與校爐火鉗能證明神殿風口是否失衡。',
      spirit: '牠不是普通怪物，而是矮人用來限制火山核心失控的古老安全機制。',
    },
  },
  ...
  wolf_king: {
    ...
    goldReward: [50, 100],
    drops: [
      { itemId: 'wolf_fang_blade', chance: 1.0, minQty: 1, maxQty: 1 },
  ...
  pirate_captain: {
    ...
    goldReward: [80, 160],
    drops: [
      { itemId: 'pirate_captain_crossbow', chance: 1.0, minQty: 1, maxQty: 1 },
  ...
  lava_colossus: {
    ...
    drops: [
      ...
      { itemId: 'obsidian_glass_plate', chance: 1.0, minQty: 2, maxQty: 3 },
      { itemId: 'fire_vent_crystal', chance: 0.8, minQty: 1, maxQty: 2 },
  ...
  crystal_dragon: {
    ...
    goldReward: [180, 360],
    drops: [
      { itemId: 'crystal_cluster_staff', chance: 1.0, minQty: 1, maxQty: 1 },
      { itemId: 'crystal_scale', chance: 1.0, minQty: 3, maxQty: 5 },
      { itemId: 'crystal_core', chance: 0.5, minQty: 1, maxQty: 1 },
  ...
  frost_giant_king: {
    ...
    goldReward: [250, 500],
    drops: [
      { itemId: 'frost_giant_greataxe', chance: 1.0, minQty: 1, maxQty: 1 },
      { itemId: 'ice_crystal', chance: 1.0, minQty: 2, maxQty: 4 },
      { itemId: 'glacier_fossil_shard', chance: 0.8, minQty: 2, maxQty: 3 },
      { itemId: 'frozen_watch_badge', chance: 0.35, minQty: 1, maxQty: 1 },
