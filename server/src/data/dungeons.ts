...
export const DUNGEON_MONSTERS: Record<string, MonsterDef> = {
  ...
  crystal_guardian_dungeon: {
    ...
    drops: [
      ...
      { itemId: 'crystal_sword', chance: 0.1, minQty: 1, maxQty: 1 },
    ],
    aiType: 'boss',
    description:
  ...
  pirate_captain_dungeon: {
    ...
    goldReward: [100, 200],
    drops: [
      { itemId: 'pirate_captain_crossbow', chance: 0.15, minQty: 1, maxQty: 1 },
  ...
  demon_lord_dungeon: {
    ...
    goldReward: [500, 1000],
    drops: [
      { itemId: 'demon_lord_giant_sword', chance: 0.1, minQty: 1, maxQty: 1 },
  ...
  elder_dragon_dungeon: {
    ...
    goldReward: [800, 1500],
    drops: [
      { itemId: 'elder_dragon_fang_spear', chance: 0.08, minQty: 1, maxQty: 1 },
...
export const DUNGEON_DEFS: Record<string, DungeonDef> = {
  ...
  pirate_ship: {
    ...
    firstClearRewards: {
      ...
      gold: 800,
      items: [
        { itemId: 'pirate_captain_crossbow', qty: 1 },
  ...
  demon_fortress: {
    ...
    firstClearRewards: {
      ...
      gold: 6000,
      items: [
        { itemId: 'demon_lord_giant_sword', qty: 1 },
  ...
  dragon_nest: {
    ...
    firstClearRewards: {
      ...
      gold: 10000,
      items: [
        { itemId: 'elder_dragon_fang_spear', qty: 1 },
