...
export const STATIC_WORLD_FILLER_ROOMS: Record<string, RoomDef> = {
  ...
  "saltwind_flats_fill_36_10": {
    ...
    "name": "鹵眼西鹽晶採封",
    "zone": "saltwind_flats",
    "description": "鹵眼西鹽晶採封位在低潮堤道南面，北側堤道石樁露出白鹽，東邊深鹵眼冒著藍黑氣泡。鹽晶路可採集硬鹽片與鹵砂，但晶殼斷裂成坑，是 gathering blocker。",
    "exits": [],
    "mapSymbol": "[·]",
    "mapX": 5,
    "mapY": 3,
  ...
  "saltwind_flats_fill_37_8": {
    ...
    "name": "潮望遺跡北熱沙封",
    "zone": "saltwind_flats",
    "description": "潮望遺跡北熱沙封位在潮望遺跡北側，南面斷牆被鹽霧磨白，西邊海蛇軌跡壓出長長凹線。熱氣從濕沙下蒸騰，這裡是純 blocker，阻止玩家從遺跡背面繞行。",
    "exits": [],
    "mapSymbol": "[·]",
    "mapX": 6,
    "mapY": 1,
  ...
  "storm_highlands_fill_n10_n14": {
    ...
    "description": "獅鷲王峰東雷崖封位在風暴高原東緣，西側可望見獅鷲王峰的黑影與狂風眼，南面雷雲沿斷崖翻滾，東方只剩碎裂岩柱。這裡是 border blocker，雷擊岩臺封住外側路線，不提供通行。",
    "exits": [],
    "mapSymbol": "[·]",
    "mapX": 8,
    "mapY": 1,
  ...
  "storm_highlands_fill_n11_n13": {
    ...
    "name": "天石堆東斷崖封",
    "zone": "storm_highlands",
    "description": "天石堆東斷崖封貼著高原北側碎崖，西面天石堆的石 cairn 被雨水磨亮，南側獅鷲王峰傳來長鳴。碎石路在東邊斷成空谷，雷風會把人推離岩臺，是封路 blocker。",
    "exits": [],
    "mapSymbol": "[·]",
    "mapX": 7,
    "mapY": 2,
  ...
  "storm_highlands_fill_n11_n15": {
    ...
    "name": "風暴玻礦東封脊",
    "zone": "storm_highlands",
    "description": "風暴玻礦東封脊位在高原南北風線交會處，西面風暴玻礦脈閃著藍白裂光，南側獅鷲王峰被雲牆遮住。岩脊上有可採碎玻礦屑，但東北風切成危險斷口，是 blocker。",
    "exits": [],
    "mapSymbol": "[·]",
    "mapX": 7,
    "mapY": 0,
