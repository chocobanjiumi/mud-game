...
export const ROOMS: Record<string, RoomDef> = {
  ...
  weapon_shop: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'starter_village_crafting_shed', description: '小工棚裡傳出磨刀與修補聲', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    npcs: ['blacksmith'],
    mapSymbol: '[W]',
    mapX: 3,
  ...
  village_gate: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'training_ground', description: '訓練場在東邊' },
      {
        ...
        edgeNote: '村口到平原入口需穿過安全哨線與草坡泥路，實際路程長於相鄰一格。',
      },
      {
        direction: 'west',
  ...
  starter_village_chapel: {
    ...
    exits: [
      { direction: 'south', targetRoomId: 'starter_village_market_lane', description: '南側禮拜堂石階穿過雨棚與祈願紙，繞到攤販燈火旁的市場小巷入口', edgeKind: 'distant_route', edgeNote: '禮拜堂到市場小巷需下石階並穿過雨棚與攤位，實際路程長於相鄰一格。' },
  ...
  starter_village_portal_shrine: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'starter_village_guard_post', description: '窄廊通向守衛哨所下方', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    mapSymbol: '[O]',
    mapX: 2,
    mapY: 4,
  ...
  starter_village_market_lane: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'weapon_shop', description: '西側市場石路穿過攤棚與木箱堆，繞過鐵匠煤煙後抵達武器店前門', edgeKind: 'distant_route', edgeNote: '市場小巷到武器店需穿過攤棚與貨箱，實際路程長於相鄰一格。' },
      { direction: 'north', targetRoomId: 'starter_village_chapel', description: '北側市場雨棚沿祈願紙與石階上行，避開攤販燈火回到晨光禮拜堂', edgeKind: 'distant_route', edgeNote: '市場小巷北側回禮拜堂要穿過雨棚與石階，實際路程長於相鄰一格。' },
  ...
  starter_village_crafting_shed: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'weapon_shop', description: '回到武器店前廳', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
  ...
  starter_village_notice_corner: {
    ...
    description:
      '告示角落位在廣場南西側的轉角，數塊木板被雨水泡得發黑，仍釘著尋物、採集、巡邏和協助新人的短委託。北邊是藥水店，東方可到村口，西側狹路延伸到古井。紙張邊緣有被撕下的痕跡，提示旅人查看 quest、追蹤任務目標，並留意有些委託需要 search 或 觀察 才能找到線索。木板下方散落舊蠟封與泥腳印，表示有人匆忙撕走其中一張任務單；旁邊的箭頭牌標示藥水店、古井與村口方向，使旅人能根據任務文字快速規劃路線，還能發現被雨水暈開的暗號。角落油燈下壓著一張缺角地圖，標出村內可調查處與回報路線',
    exits: [
      { direction: 'north', targetRoomId: 'potion_shop', description: '北側告示板後巷穿過雨棚與藥草木箱，沿淡綠藥粉痕跡繞回藥水店門口', edgeKind: 'distant_route', edgeNote: '告示角落到藥水店需穿過後巷雨棚與藥草箱，實際路程長於相鄰一格。' },
      { direction: 'east', targetRoomId: 'village_gate', description: '東側告示角落沿濕石路穿過任務牌與守衛火把，繞到村口柵門內側', edgeKind: 'distant_route', edgeNote: '告示角落到村口需沿濕石路穿過任務牌與火把區，實際路程長於相鄰一格。' },
  ...
  starter_village_guard_post: {
    ...
    exits: [
      { direction: 'west', targetRoomId: 'starter_village_portal_shrine', description: '窄廊通往傳送祠堂', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      { direction: 'east', targetRoomId: 'starter_village_rooftop_walk', description: '東側哨所窄廊沿木柵上緣延伸，越過火把平台後接上屋頂棧道入口', edgeKind: 'distant_route', edgeNote: '守衛哨所到屋頂棧道需沿木柵上緣與火把平台繞行，實際路程長於相鄰一格。' },
    ],
    mapSymbol: '[B]',
    mapX: 2,
    mapY: 5,
  ...
  starter_village_stable_yard: {
    ...
    exits: [
      ...
      { direction: 'west', targetRoomId: 'starter_village_crafting_shed', description: '修補工棚在西邊', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      { direction: 'south', targetRoomId: 'starter_village_rooftop_walk', description: '南側馬廄木階穿過乾草棚與車輪架，沿屋簷陰影接上屋頂棧道入口', edgeKind: 'distant_route', edgeNote: '馬廄院到屋頂棧道需穿過乾草棚與車輪架，實際路程長於相鄰一格。' },
    ],
    mapSymbol: '[H]',
    mapX: 4,
    mapY: 4,
  ...
  starter_village_rooftop_walk: {
    ...
    exits: [
      { direction: 'south', targetRoomId: 'training_ground', description: '南側棧道木梯沿繩索護欄折降，繞過稻草靶後回到訓練場北側空地', edgeKind: 'distant_route', edgeNote: '屋頂棧道回訓練場需下木梯並繞過訓練器具，實際路程長於相鄰一格。' },
      { direction: 'west', targetRoomId: 'starter_village_guard_post', description: '西側屋頂棧道沿木柵上緣回走，越過火把平台與窄廊抵達守衛哨所', edgeKind: 'distant_route', edgeNote: '屋頂棧道到守衛哨所需沿木柵上緣與火把平台繞行，實際路程長於相鄰一格。' },
      { direction: 'north', targetRoomId: 'starter_village_stable_yard', description: '北側屋簷木階穿過車輪架與乾草棚陰影，折下到馬廄院泥地旁的燈柱', edgeKind: 'distant_route', edgeNote: '屋頂棧道到馬廄院需沿木階穿過車輪架與乾草棚，實際路程長於相鄰一格。' },
    ],
    mapSymbol: '[^]',
    mapX: 3,
    mapY: 4,
    ...
    exits: [
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '平原入口回村口需穿過草坡泥路與安全哨線，實際路程長於相鄰一格。',
      },
      ...
      { direction: 'west', targetRoomId: 'sunflower_field', description: '西邊的花田在陽光下閃耀', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
  ...
  crossroads: {
    ...
    exits: [
      ...
      },
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '十字路口到湖畔城門跨越城外道路與外牆緩坡，實際路程長於相鄰一格。',
      },
  ...
  forest_entrance: {
    ...
    description:
      '兩株巨大橡樹像門衛般立在暗影森林入口，交錯枝椏形成天然拱門，濕冷樹根從泥土裡隆起。北方道路退回平原十字路口，南側密林小道吞沒光線，東邊樹屋階梯纏滿藤蔓，西側霜雪小路通往更冷的區域，寒風石碑明確標出高階危險。鳥鳴從樹冠四面傳來卻看不到鳥影，地面狼毛與新鮮爪痕提示旅人進入後會遭遇暗影狼伏擊',
    exits: [
      {
        direction: 'north',
  ...
  dense_trail: {
    ...
    description:
      '越往深處走，樹木越高，藤蔓和荊棘幾乎把道路擠成窄縫，厚落葉吸走腳步聲，只剩遠處不自然的枝條摩擦聲。北面可退回森林入口，西邊飄來沼澤腐甜氣味，南方深林更暗，東側螢光若隱若現。臉上偶爾黏到冰冷蛛絲，提示巨型蜘蛛可能在頭頂結網，旅人應留意方向與伏擊。此處還留著可追蹤的任務痕跡、隱蔽標記與危險預兆，適合先仔細調查再推進。牆角或地面標記也會指出下一個安全出口',
    exits: [
      ...
      { direction: 'east', targetRoomId: 'firefly_trail', description: '林間閃爍著微弱的螢光', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
      { monsterId: 'shadow_wolf', maxCount: 2, respawnSeconds: 45 },
  ...
  mushroom_swamp: {
    ...
    description:
      '泥地在腳下慢慢下陷，紫黑水泡從沼澤表面鼓起又破裂，巨大螢光蘑菇照出病態綠光，有些菌傘高過人頭。東面回到密林小道，西方毒霧更濃，泥水裡可見蛛腿般的細長倒影。腐敗甜味和潮濕木屑味混在一起，最大的蘑菇根部埋著發光材料，提示旅人可採集但也可能驚動蜘蛛與樹精。蘑菇沼澤周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。',
    exits: [
  ...
  deep_forest: {
    ...
    description:
      '森林深處幾乎吞掉所有光線，古老樹根盤踞在地面上，像沉睡巨蛇繞過腐葉和黑水坑。北方可退回密林小道，南方精靈遺跡透出微弱藍光，西側枯萎之林散出灰燼味。幽暗裡一雙雙綠眼保持距離跟隨，地上有巨大狼爪與被拖走獵物的痕跡；這裡是暗影狼王與暗影樹靈的活動邊界，旅人進入前應確認藥水、裝備和任務目標' +
  ...
  elf_ruins: {
    ...
    description:
      '穿過重重樹幕後，開闊遺跡像被森林吞下的廣場般出現，斷裂白石柱刻滿精靈文字，地面魔法陣雖黯淡仍有藍光沿刻痕流動。北面回到森林深處，南方空氣逐漸灼熱通往火山地帶，東側老樹叢深處傳來低沉脈動。祭壇中央的水晶映出破碎記憶與任務線索，是地標、劇情與 Boss 事件的核心節點，旅人可 觀察 符文確認暗影來源' +
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'dark_forest_root_bridge', description: '東側盤根橋接往荊棘迷宮' },
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '精靈遺跡到火山山腳跨越森林邊界與熱風荒地，實際路程長於相鄰一格。',
      },
    ],
    monsters: [
      { monsterId: 'giant_spider', maxCount: 2, respawnSeconds: 50 },
  ...
  cave_entrance: {
    ...
    description:
      '古井井壁後藏著狹窄通道，盡頭是一處天然洞窟入口，岩壁鑲著零星幽藍水晶，涼風帶出潮濕礦物味。上方繩索可攀回古井，南方螢光隧道像星河般延伸，北側廢棄礦車道通向地面。洞頂倒掛蝙蝠，入口岩縫裡有水晶原石，提示旅人這裡是進入洞窟前的安全錨點與第一個戰鬥遭遇。洞窟入口周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。',
    exits: [
      {
        direction: 'east',
  ...
  luminous_tunnel: {
    ...
    description:
      '隧道兩壁嵌滿大小不一的水晶，彩光在黑暗中層層折射，讓濕滑地面像鏡子般映出星河。北面回洞窟入口，南方水晶大廳透出耀眼光芒，東邊地下河水聲清晰，西側紫色通道帶來眩暈感。水晶閃爍裡有蜥蜴偽裝的影子，提示旅人需觀察異常反光，並小心在光滑地面戰鬥時被逼退。螢光隧道周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。' +
  ...
  crystal_hall: {
    ...
    description:
      '宏偉天然大廳在隧道盡頭展開，穹頂高得像地底教堂，巨型水晶柱從地面直插天頂，把光折成萬千色彩。北側回螢光隧道，南方礦脈深處傳來沉重震動，中央符文石台被環形階梯包圍。石像鬼雕塑排列在柱間，其中幾尊姿態過於僵硬，提示這裡是地標、Boss 前哨與解謎核心；旅人可 觀察 石台符文開啟後續路線' +
  ...
  underground_river: {
    ...
    description:
      '寬闊地下河在洞窟暗處蜿蜒流動，清澈河水能看見河床上的發光水晶碎片，岸邊螢光苔蘚散出柔綠光。西面回螢光隧道，東方瀑布轟鳴越來越響，水面偶爾泛起不自然漣漪。河泥上有蜥蜴爪印與被沖來的礦石袋，提示旅人可採集、追蹤水流或準備水邊伏擊戰。地下河周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。',
    exits: [
  ...
  mine_depths: {
    ...
    description:
      '裸露礦脈在岩壁上閃著金屬光澤，巨型水晶像熔爐般散出熱能，讓空氣沉重而壓抑。北面回水晶大廳，東側階梯通往古代祭壇，西邊能聽見礦工營地殘破滑輪聲。地面有新舊鑿痕、晶粉和守衛石像的碎片，提示旅人可採礦、尋找古代機關，也會遭遇石像鬼與水晶蜥蜴巡守。礦脈深處周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。' +
    ...
    exits: [
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '湖畔城門回十字路口需要穿過城外道路與外牆緩坡，實際路程長於相鄰一格。',
      },
      { direction: 'east', targetRoomId: 'market_street', description: '進入商業街' },
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '湖畔城門南側到東方海岸棧道需穿過外道與鹽風木階，實際路程長於相鄰一格。',
      },
    ],
    mapSymbol: '[=]',
    mapX: 3,
  ...
  market_street: {
    ...
    description:
      '熙熙攘攘的石板商業街沿湖岸展開，武器鋪、防具店、藥材行與雜貨舖掛著不同顏色的燈籠。烤肉煙、香料味與湖水潮氣混在一起，攤販叫賣聲壓過馬車輪聲。西側通回城門，東面通往廣場，北邊酒館門縫飄出酒香；旅人可在此補給、比價、接商人委託，也能 search 貨箱找到異常標記。街角公告牌列出每日採購清單與缺貨材料，南側鍛坊傳來敲鐵聲，提醒旅人可以把剛取得的裝備立刻修理、分解或換成旅途消耗品，也可比較拍賣場與商店價格再決定出售。路邊巡邏會提示可疑商販位置與安全出口，攤位後方還留有通往倉庫的小路',
    exits: [
  ...
  village_backhill: {
    ...
    exits: [
      { direction: 'south', targetRoomId: 'village_creek', description: '山坡小路繞向溪邊', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      { direction: 'east', targetRoomId: 'village_outskirts', description: '山坡路接回村外小路', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
  ...
  village_outskirts: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'graveyard_entrance', description: '遠處隱約可見鐵門' },
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '村外小路回村口需要沿野花坡與木柵牆繞行，實際路程長於相鄰一格。',
      },
      { direction: 'west', targetRoomId: 'village_backhill', description: '山坡路通往村莊後山', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
  ...
  starter_ext_old_mill_path: {
    ...
    description:
      '一條泥濘小徑沿著農田灌渠延伸到舊磨坊，半塌的水車仍被溪水推得吱呀作響，空氣裡有潮木和舊麥粉味。西側回農田，東面可到蛙鳴池，南邊灰煙指向炭窯。路旁散落破麻袋與田鼠怪物腳印，旅人可 search 水車底部尋找丟失麥袋，也可能驚動躲在糧袋裡的鼠群。舊磨坊小徑周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。',
    exits: [
      {
        direction: 'west',
        targetRoomId: 'village_farmland',
  ...
  starter_ext_herb_garden: {
    ...
    description:
      '村醫照看的藥草圃被矮籬圍住，薄荷、止血草與紫葉草分成整齊小畦，露水在葉尖閃著柔綠光。北面是蜂巢樹叢，西南可繞回村外小路。泥土裡有被啃咬的根莖和小腳印，旅人可 採集 藥草、search 破陶牌找配方線索，也能追查田鼠是否把草根拖向墓地。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
      { direction: 'north', targetRoomId: 'starter_ext_beehive_grove', description: '回到蜂巢樹叢' },
      { direction: 'west', targetRoomId: 'starter_ext_training_clearing', description: '西側木樁小徑接往練習空地', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
      { monsterId: 'field_rat', maxCount: 2, respawnSeconds: 30 },
    ],
  ...
  starter_ext_training_clearing: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'starter_ext_bandit_footpath', description: '可疑腳印往東延伸', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
  ...
  starter_ext_bandit_footpath: {
    ...
    description:
      '一條被硬靴踩出的窄路藏在荊棘後，斷枝、布條和偷來的麻繩沿路散落，夕光被樹影切得很碎。西面回練習空地，南側通往空心樹樁，東面隱約能看見柳樹神龕。這裡提示村外已不只有小怪，旅人可 search 足跡找盜匪藏物，也要準備面對落單盜賊或被驚動的烏鴉。此處還留著可追蹤的任務痕跡、隱蔽標記與危險預兆，適合先仔細調查再推進。牆角或地面標記也會指出下一個安全出口',
    exits: [
      { direction: 'west', targetRoomId: 'starter_ext_training_clearing', description: '回到練習空地', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      { direction: 'south', targetRoomId: 'starter_ext_hollow_stump', description: '足跡繞向空心樹樁', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      { direction: 'east', targetRoomId: 'starter_ext_willow_shrine', description: '柳枝後有一座小神龕', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
  ...
  starter_ext_willow_shrine: {
    ...
    description:
      '古老柳樹垂下長長枝條，枝間掛著村民祈願木牌，石製小神龕被銀色暮光照亮，空氣裡有濕葉與香灰味。西側藏著盜匪足跡，南邊坡道通往墓地入口，東面有繞回瞭望台的窄路。神龕前的供盤被移動過，旅人可 觀察 木牌找出失蹤孩童的願望，也能 search 祭壇底座取得一次性祝福或任務線索。柳枝上有烏鴉羽毛與被扯斷的紅線，暗示盜匪曾在這裡觀察村民動向。若旅人先清理周圍小怪，再調查供盤灰痕，就能把墓地、瞭望台與村外支線串在一起。神龕背面刻著舊巡邏記號，提示安全返回村口的路線標示',
    exits: [
      { direction: 'west', targetRoomId: 'starter_ext_bandit_footpath', description: '荊棘路回到盜匪足跡', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      {
        direction: 'south',
        targetRoomId: 'graveyard_entrance',
  ...
  starter_ext_root_cellar: {
    ...
    description:
      '廢棄小屋地板下藏著低矮根窖，粗樹根穿過土牆，陶罐、乾草藥與破布袋散發潮土氣味，唯一的提燈把木架影子拉長。北側梯子回小屋，深處根鬚指向更遠的空心樹樁，但需要從盜匪足跡繞路接近。旅人可 search 陶罐取得補給或配方碎片，也可能撞見偷藏糧食的田鼠，是早期資源與隱藏探索節點。此處還留著可追蹤的任務痕跡、隱蔽標記與危險預兆，適合先仔細調查再推進。牆角或地面標記也會指出下一個安全出口',
    exits: [
  ...
  starter_ext_charcoal_kiln: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'starter_ext_ruined_bridge', description: '灰路通向斷橋', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      {
        direction: 'south',
        targetRoomId: 'graveyard_entrance',
  ...
  starter_ext_ruined_bridge: {
    ...
    description:
      '一座老木橋斷在淺溝上方，腐朽木板垂進水裡，橋樁長滿苔蘚，陰雲讓溝底水面顯得發冷。北面通蛙鳴池，西側灰路回炭窯，東邊可接村外小路。這裡是路線事件點，旅人可 觀察 斷木判斷是否被人破壞，search 橋下取回掉落貨物，也可能被史萊姆從水溝邊偷襲。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
      { direction: 'east', targetRoomId: 'starter_ext_frog_pond', description: '東側水聲通回蛙鳴池' },
      { direction: 'west', targetRoomId: 'starter_ext_charcoal_kiln', description: '灰路回到炭窯', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
      { monsterId: 'green_slime', maxCount: 2, respawnSeconds: 30 },
    ],
  ...
  starter_ext_hollow_stump: {
    ...
    description:
      '一截巨大的空心樹樁倒在灌木深處，內部被挖出根道，偷來的鈕扣、麥粒和小銅幣塞在樹洞裡，綠色光束從裂縫照入。北側是盜匪足跡，西邊根痕指向遠處根窖但無法直接通行，南面小坡可回墓地深處外牆。旅人可 search 樹洞取得一次性藏物，觀察 根道確認小怪巢穴，也要準備面對較密集的田鼠群與烏鴉騷擾。樹洞底部有新鮮爪痕和被咬破的任務布袋，提示這裡是低等區域的小型精英事件點；若先調查根窖線索，再從盜匪足跡繞進來，可以避開部分迷路風險並保留撤退路。樹皮刻痕還指向墓地外牆，暗示盜匪與亡者活動可能相互牽連，需要追查來源處',
    exits: [
      { direction: 'north', targetRoomId: 'starter_ext_bandit_footpath', description: '回到盜匪足跡', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      {
        direction: 'south',
        targetRoomId: 'graveyard_depths',
    ...
    exits: [
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '海邊棧道北側回湖畔城門需要走完整段外道，實際路程長於相鄰一格。',
      },
  ...
  eastern_coast_tidepool_grotto: {
    ...
    description:
      '潮間帶西側有一處被礁石遮住的小岩穴，鏡面般的潮池映出洞頂貝殼紋，藍色反光讓石壁像濕玻璃。東面回潮間帶，南側裂縫連到海蝕洞。旅人可 search 潮池底部找半寶石和古幣，也能 觀察 貝殼排列判斷下一次退潮時間；海蟹會躲在淺池邊伏擊。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
      {
        direction: 'east',
        targetRoomId: 'tidal_zone',
  ...
  eastern_coast_seaweed_flats: {
    ...
    description:
      '大片海藻覆蓋退潮後的平灘，濕滑葉片纏住漂木與破網，空氣裡滿是鹽味和腐藻氣息。北面回沙灘，東側水線通到珊瑚淺灘，南邊可繞向潮池岩穴。旅人可 採集 海藻材料、search 破網找漁民遺失的鉤具，也要避開藏在淺水中的水母。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
      {
        direction: 'north',
  ...
  eastern_coast_smugglers_cove: {
    ...
    description:
      '海崖背風處藏著狹窄海灣，黑布蓋住的貨箱堆在礁石後，暗色提燈按固定節奏閃爍，浪聲掩蓋了低聲交談。西面回海崖步道，南側可繞到海盜藏貨處，東邊小徑通往風暴瞭望崖。旅人可 觀察 提燈節奏找走私暗號，search 貨箱取得任務證物，但會引來海盜巡邏。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰。此處還留著可追蹤的任務痕跡、隱蔽標記與危險預兆，適合先仔細調查再推進',
    exits: [
      {
        direction: 'west',
  ...
  eastern_coast_broken_pier: {
    ...
    description:
      '漁村碼頭南側有一段斷裂棧橋，木樁被風浪撞歪，鬆動木板下傳來海蟹刮擦聲，雲光在焦油水面上晃動。北面回漁村碼頭，南面可接燈塔，東側潮溝通往珍珠床。旅人可 觀察 斷樁判斷是否被海盜破壞，search 漁網找修橋材料，也要處理爬上木板的海蟹。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
      {
        direction: 'north',
        targetRoomId: 'fishing_dock',
      ...
      { direction: 'south', targetRoomId: 'cliff_path', description: '南側斷木棧道接上海崖步道' },
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '斷裂棧橋到燈塔是沿岸斜向長路徑，不是直接相鄰房間。',
      },
    ],
    monsters: [
      { monsterId: 'sea_crab', maxCount: 3, respawnSeconds: 35 },
  ...
  eastern_coast_pearl_bed: {
    ...
    description:
      '燈塔外側的淺水沙床布滿蚌殼，細沙間偶爾閃出乳白珍珠光，陽光穿過水面形成搖晃光網。西面接斷裂棧橋，南面通珊瑚淺灘，東側水流暗暗指向海蛇巢。旅人可 採集 珍珠與貝殼材料，search 被撬開的蚌殼找盜採線索，也要小心水母漂入採集路線。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
  ...
  eastern_coast_pirate_cache: {
    ...
    description:
      '海盜營地後方的岩縫裡藏著半埋貨箱，破黑旗蓋住火藥桶與酒桶，紅色營火把濕石照得像血。北面通走私者海灣，西側可回海盜營地，南面有窄路接沉船殘骸。這裡是精英藏寶點，旅人可 search 貨箱取得一次性寶物或任務證物，觀察 酒桶標記確認海盜船長補給線，但會引來強化巡邏。此處還留著可追蹤的任務痕跡、隱蔽標記與危險預兆，適合先仔細調查再推進。牆角或地面標記也會指出下一個安全出口',
    exits: [
  ...
  eastern_coast_serpent_nest: {
    ...
    description:
      '暗礁外緣的裂谷裡堆滿魚骨、破船板與黏滑卵囊，綠色水光從鋸齒狀礁壁間閃爍，低沉嘶聲在水下震動。西面暗流接珍珠床，北側水面能看見觀潮斷崖但沒有可攀爬路線，南面可潛入暗礁深處。這裡是大型事件鉤子，旅人可 觀察 卵囊判斷海蛇活動週期，search 骨堆找到沉船線索，也要準備面對成群海蛇和魚人支援',
    exits: [
      ...
      { direction: 'south', targetRoomId: 'eastern_coast_pirate_cache', description: '南側暗流水線通往海盜藏貨處' },
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '海蛇巢到暗礁需要沿水下裂谷斜向前進，屬於長路徑。',
      },
    ],
    monsters: [
    ...
    exits: [
      {
        ...
        edgeKind: 'distant_route',
        edgeNote: '火山山腳回精靈遺跡需要跨越火山邊界與焦黑林緣，實際路程長於相鄰一格。',
      },
  ...
  magma_river: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'obsidian_cave', description: '南側岩漿河沿冷卻黑石河岸下切，穿過熱浪裂階與漆黑洞口抵達黑曜石洞', edgeKind: 'distant_route', edgeNote: '岩漿河到黑曜石洞需沿冷卻河岸與熱浪裂階下切，實際路程長於相鄰一格。' },
  ...
  obsidian_cave: {
    ...
    exits: [
      { direction: 'north', targetRoomId: 'magma_river', description: '北側黑曜石洞沿漆黑洞口回穿，越過熱浪裂階與冷卻黑石河岸回到岩漿河', edgeKind: 'distant_route', edgeNote: '黑曜石洞回岩漿河需沿洞口與冷卻河岸回穿，實際路程長於相鄰一格。' },
  ...
  forge_hall: {
    ...
    exits: [
      ...
      { direction: 'south', targetRoomId: 'volcano_forge_storage', description: '南側鍛造大廳沿服務長廊轉入，穿過冷卻架、礦錠推車與黑鐵庫門抵達鍛造庫房', edgeKind: 'distant_route', edgeNote: '鍛造大廳到鍛造庫房需沿服務長廊與黑鐵庫門轉入，避免與星隕坑入口座標重疊，屬於長路徑。' },
    ],
  ...
  volcano_ash_field: {
    ...
    description:
      '火山山腳西側是一片厚重灰原，黑色灰丘被熱風吹成波紋，偶爾有暗紅火星從裂縫中飄起。東面回火山山腳，南方灰原延伸向更深的火山地帶，灰層下露出被噴發帶出的礦石。旅人可 search 灰丘找火成礦與舊行囊，也要留意火蜥蜴在灰下留下的爪痕。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
  ...
  volcano_steam_lift: {
    ...
    description:
      '矮人建造的升降梯卡在礦坑與火山外壁之間，黃銅齒輪、鐵鏈和蒸汽管道不停震動，白霧帶著金屬味噴向岩壁。西側管線通往熔岩橋但維修階已坍塌，東側能聽見礦坑敲擊聲但門軌卡死，南方通向黑曜石採場。旅人可 觀察 控制桿啟用捷徑，search 工具箱找維修材料，也要提防從管道裡鑽出的熔岩蟲。蒸汽升降梯周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。',
    exits: [
  ...
  volcano_ember_barracks: {
    ...
    description:
      '礦坑東側的兵房由黑鐵和玄武岩砌成，鐵床旁堆著盾牌、戰斧與尚未冷卻的煤盆，煙味混著汗水和礦粉。西面回矮人礦坑，南方走廊接鍛造庫房，東側晶光來自噴氣口但隔著封死的玄武岩牆。旅人可 觀察 值勤表觀察守衛換班，search 武器架找任務證物，但會引來矮人守衛盤查。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰。此處還留著可追蹤的任務痕跡、隱蔽標記與危險預兆，適合先仔細調查再推進',
    exits: [
  ...
  volcano_obsidian_quarry: {
    ...
    description:
      '黑曜石洞東側被開鑿成階梯採場，黑玻璃般的石面反射紅色礦脈，礦車軌道在平台間彎曲。西面回黑曜石洞，北側接蒸汽升降梯，東北方火晶噴氣口仍在轟鳴但採場邊坡已崩落。旅人可 採集 黑曜石、search 廢礦車找稀有礦樣，也要防備岩石巨人從倒影中逼近。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
  ...
  volcano_forge_storage: {
    ...
    description:
      '鍛造大廳東側的庫房堆滿鐵錠、黑曜石板與標記清楚的工具箱，冷卻架上還冒著白煙，牆角傳來低沉爐鳴。西面回鍛造大廳，北側貨道接餘燼兵房。旅人可 search 鎖箱取得材料樣本，觀察 出庫牌追蹤鍛造任務需求，也要處理從通風口竄出的火元素。這裡是火山資源線的城鎮服務延伸點，貨架按武器、護甲、飾品和消耗品分區，方便旅人確認缺少哪種礦材。牆上封蠟記錄還標示哪些箱子屬於公會訂單，錯拿會觸發守衛盤查。地上的紅色箭頭指向熔爐、礦坑與兵房三個出口，讓滿載材料的旅人能快速選擇加工、補給或撤退方向',
    exits: [
      { direction: 'west', targetRoomId: 'forge_hall', description: '西側鍛造庫房穿過黑鐵庫門折返，沿礦錠推車與冷卻架服務長廊回到鍛造大廳', edgeKind: 'distant_route', edgeNote: '鍛造庫房回鍛造大廳需沿黑鐵庫門與服務長廊折返，避免與星隕坑入口座標重疊，屬於長路徑。' },
      {
        direction: 'north',
        targetRoomId: 'volcano_crystal_vent',
  ...
  volcano_colossus_arena: {
    ...
    description:
      '火山頂東側的圓形競技台懸在岩漿湖上方，玄武岩地面刻著矮人封印鏈，中央巨大的熔岩巨像首領輪廓在火光裡慢慢抬頭。西面可退回火山頂，北側玄武岩階提供繞行撤退路。這裡是 Boss 事件鉤子，旅人可 觀察 封印鏈確認巨像階段，search 斷裂鎖扣找召喚材料，也要準備火焰精靈與岩石巨人的支援。熔岩巨像競技台周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。',
    exits: [
  ...
  snowfield_entrance: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'blizzard_path', description: '踏入暴風雪中', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
      { direction: 'south', targetRoomId: 'mountain_camp', description: '南方有營火的光芒', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
  ...
  mountain_camp: {
    ...
    exits: [
      ...
      { direction: 'west', targetRoomId: 'frozen_wastes_abandoned_sledge', description: '西側雪地有廢棄雪橇', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
  ...
  crystal_ice_cave: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'frozen_wastes_crystal_spire', description: '晶柱裂縫通向冰晶尖塔', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
      { monsterId: 'ice_elemental', maxCount: 2, respawnSeconds: 50 },
  ...
  ice_castle_gate: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'ice_throne', description: '推開冰門，進入城堡', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。', locked: true, keyItemId: 'gold_key' },
  ...
  ice_throne: {
    ...
    exits: [
      ...
      { direction: 'east', targetRoomId: 'frozen_wastes_dragon_breath_rift', description: '冰霧裂谷傳來龍息', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
  ...
  frozen_wastes_snowdrift_pass: {
    ...
    description:
      '雪原入口西側的隘口被高高積雪擠成狹長通道，半埋路標只露出鐵環，風把雪粒打在岩壁上發出沙沙聲。東面回雪原入口，北側可接暴風雪路外緣，南面通往廢棄雪橇。旅人可 觀察 路標判斷安全路線，search 雪堆找被埋補給，也要防備雪狼沿著隘口追擊。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
  ...
  frozen_wastes_ice_fishing_hole: {
    ...
    description:
      '凍湖西側被人鑿出圓形冰洞，釣線和骨針掛在木架上，冰下魚影在幽藍水光裡緩慢游動。東面回凍湖，南方可聽見暴風雪路的風聲但雪牆封路，西側冰面裂縫只能看見冰河深處藍光，需從冰河入口繞行。旅人可 採集 魚材或 search 魚簍找失蹤漁人的牌子，也要注意冰元素從水下凝聚。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
  ...
  frozen_wastes_frostpine_grove: {
    ...
    exits: [
      ...
      { direction: 'north', targetRoomId: 'frozen_wastes_runestone_circle', description: '北側霜松斷枝標記穿過極光雪坡與冰霜林隙，抵達古老符石環外圈', edgeKind: 'distant_route', edgeNote: '霜松林到符石環需沿斷枝標記穿過極光雪坡，實際路程長於相鄰一格。' },
    ],
    monsters: [
      { monsterId: 'snow_wolf', maxCount: 3, respawnSeconds: 40 },
      { monsterId: 'frostpine_stalker', maxCount: 1, respawnSeconds: 55 },
  ...
  frozen_wastes_abandoned_sledge: {
    ...
    description:
      '一輛破裂雪橇半埋在雪坡下，斷裂滑木、翻倒箱子和凍成黑色的血痕指向風雪深處，寒風穿過繩索發出細響。北面回積雪隘口，東側可回雪山營地，南邊坡道接雪人石堆。旅人可 search 箱子找一次性補給，觀察 血跡追蹤襲擊者，也要防備被氣味吸引來的雪狼。此處的足跡、聲響或資源痕跡會提示旅人放慢腳步，先觀察危險再採集或開戰',
    exits: [
      ...
      { direction: 'south', targetRoomId: 'frozen_wastes_yeti_cairn', description: '巨大腳印通往雪人石堆', edgeKind: 'distant_route', edgeNote: '此出口依世界全圖座標不是相鄰一格，實際路程長於相鄰一格，保留為明確特殊路線。' },
    ],
    monsters: [
  ...
  frozen_wastes_glacier_crevasse: {
    ...
    description:
      '冰河西側裂開一道深藍裂縫，繩梯結滿冰霜，冰壁中封著古代獸骨和破碎器具，深處傳來空洞回聲。東面攀回冰河，北側裂壁暗道先接到半埋雪坡下的廢棄雪橇，再沿雪坡回到積雪隘口。旅人可 觀察 冰壁化石找考古線索，search 凍住的包裹取得材料，也要注意冰元素從裂縫裡浮出。冰河裂縫周邊的地貌、入口、出口與危險痕跡需要清楚呈現，讓隊伍能從相鄰房間、地面材質與回程標記判斷探索方向、採集位置、任務線索與安全退路。',
    exits: [
  ...
  frozen_wastes_runestone_circle: {
    ...
    description:
      '極光之地西側立著一圈古老符石，冰雪祭壇位於中央，綠紫光柱在符文間緩慢移動，空氣中有細小靜電聲。東面回極光之地，南側霜松林可作撤退路，北面雪坡通向結冰哨塔。旅人可 觀察 符文順序解讀冰之王朝歷史，search 祭壇底座取得任務線索，也會吸引雪人和冰元素靠近。每塊符石都刻著不同方向記號，能把凍湖、城堡與哨塔路線串起來；若旅人在極光最亮時調查，還能看到王朝滅亡前的幻象片段。祭壇旁的凍裂刻痕提示需要冰晶材料啟動，適合作為探索任務與傳送解鎖線索和支線入口處之一',
    exits: [
      ...
      { direction: 'north', targetRoomId: 'frozen_wastes_frozen_watchpost', description: '北側符石環雪坡穿過王朝巡邏標記與斷冰橋陰影，沿冰牆缺口通向結冰哨塔', edgeKind: 'distant_route', edgeNote: '符石環到結冰哨塔需穿過巡邏標記與斷冰橋陰影，實際路程長於相鄰一格。' },
    ],
    monsters: [
      { monsterId: 'yeti', maxCount: 2, respawnSeconds: 60 },
  ...
  frozen_wastes_yeti_cairn: {
    ...
    description:
      '幾座巨石堆立在雪坡上，石縫中插著破矛和獸骨，周圍巨大腳印深深陷入冰雪，低沉咆哮在風中迴盪。北面通霜松林，東側窄洞可聽見雪狼巢穴回聲但冰壁坍塌，西面可繞回冰晶洞穴。這裡是精英事件房，旅人可 觀察 石堆判斷雪人祭祀路線，search 骨堆找失蹤旅人證物，也要準備面對雪人與狼群同時出現。石堆頂端掛著被凍住的鈴鐺，搖動後會引來更強巡邏；但若先破壞狼群嗅跡，隊伍可安全撤回松林。雪坡上的巨大足印還指向城堡外牆，提示雪人可能受冰堡力量驅使。石堆陰影裡另有可採集的霜骨碎片與任務布條痕跡',
    exits: [
  ...
  frozen_wastes_frozen_watchpost: {
    ...
    description:
      '冰封城堡東側的哨塔被厚冰包住，破裂號角掛在城垛上，霜巨人腳印從塔門一路延伸到雪坡。西面回城堡大門，南方可通冰晶尖塔，東側冰晶尖塔在藍光裡閃爍但冰橋已斷。旅人可 觀察 號角判斷守衛警戒狀態，search 兵器架找舊王朝徽章，也要提防霜巨人從塔內甦醒。塔頂視野能看到冰堡、極光和龍息裂谷三條路線，適合作為隊伍進攻前的觀察點；但號角聲會提升整片城牆的警戒。哨塔內的結冰地圖標出巡邏間隔，能協助旅人選擇先走大門還是尖塔側路，並記錄安全撤退信號。牆角火盆已熄滅，可調查燃料缺口與守衛失蹤原因',
    exits: [
  ...
  frozen_wastes_dragon_breath_rift: {
    ...
    description:
      '裂谷兩側冰壁高聳，藍白龍息在裂縫中翻滾，岩壁布滿巨大爪痕和被凍住的鎖鏈碎片。西面是凍結的荒原通道，南側晶光可看見冰晶尖塔但裂谷無法直接攀降，北面寒霧可通向魔族邊境裂口。這裡是大型 Boss 事件鉤子，旅人可 觀察 爪痕判斷冰龍活動階段，search 鎖鏈碎片找封印材料，也要準備面對冰龍幼崽的突然甦醒。裂谷底部每隔一段時間會噴出寒流，提示隊伍注意站位與撤退方向；遠處黑煙也預告下一區魔族領地的銜接。若帶著城堡鑰匙調查裂縫邊緣，能看到通往王座密室的冰階輪廓與寶箱線索標記，以及裂谷出口',
    exits: [
...
const DESCRIPTION_OVERRIDES: Record<string, string> = {
  kingdom_frontier_fill_n10_n7: '號角獵門口穿過王室獵場西側界碑，西面邊境巡邏路仍有軍靴印，東側獵場號角門掛著舊銅環。磨損石墩標出獵場與軍管區分界，是明確跨區通路；兩側都有巡邏繩標、放行牌與獵角警示。門下石板刻著王室獵令。kingdom_frontier_fill_n10_n7周邊的地面材質、相鄰地貌、邊界標記與回程方向需要清楚呈現，讓隊伍能從北南東西的路徑線索判斷此處是通行、採集、服務、封閉或跨區銜接點。',
  kingdom_frontier_fill_n10_n6: '邊境巡邏路在獵場鹿徑西側延伸，西面是軍方哨旗與低牆，東側草叢裡可見王室與軍方的雙重界標。這是通往王家獵場鹿徑的 邊界 路線，路面仍受巡邏管制；界碑旁有警告牌、蹄印與巡邏繩標。玩家可辨認唯一放行缺口。kingdom_frontier_fill_n10_n6周邊的地面材質、相鄰地貌、邊界標記與回程方向需要清楚呈現，讓隊伍能從北南東西的路徑線索判斷此處是通行、採集、服務、封閉或跨區銜接點。',
  eastern_coast_fill_39_2: '霧港西門路牌潮徑位在東海岸最東端，西面霧港西潮前帶仍有礁水聲，東面濃霧中露出霧港城門拱影與銅鐘輪廓。路牌亭標示這裡是跨區 邊界 路線 端點，專門銜接東海岸與霧港入口，不放怪物或採集玩法。eastern_coast_fill_39_2周邊的地面材質、相鄰地貌、邊界標記與回程方向需要清楚呈現，讓隊伍能從北南東西的路徑線索判斷此處是通行、採集、服務、封閉或跨區銜接點。',
  bloodsalt_coast_fill_47_9: '深海神殿西沉門路牌亭位在血鹽海岸最東端，西面斷棧只剩鹽蝕木樁，東側半沉石門刻滿古文，門後透出藍色火光。路牌亭標示這裡是跨區邊界路線端點，專門銜接血鹽海岸與深海神殿潮門，不放一般遭遇。bloodsalt_coast_fill_47_9周邊的地面材質、相鄰地貌、邊界標記與回程方向需要清楚呈現，讓隊伍能從北南東西的路徑線索判斷此處是通行、採集、服務、封閉或跨區銜接點。',
  ...
  frostbite_pass_fill_n19_n14: '高原崖門西凍路牌位在霜咬隘口東北界，北面惡魔邊境冷影壓在山脊上，南側雨棚西界凍石路繼續下滑，東邊風暴高原崖門透出濕暖風。這裡是跨區邊界路線端點，只銜接隘口與高原崖門。frostbite_pass_fill_n19_n14周邊的地面材質、相鄰地貌、邊界標記與回程方向需要清楚呈現，讓隊伍能從北南東西的路徑線索判斷此處是通行、採集、服務、封閉或跨區銜接點。',
  frostbite_pass_fill_n19_n13: '雨棚西界凍石路牌位在霜咬隘口東側，北面崖門西界繼續抬升，南側薄冰坡被冷雨封住，東邊風暴高原雨棚有濕暖氣流。路牌標示這裡是跨區邊界路線端點，專門銜接隘口與高原雨棚。frostbite_pass_fill_n19_n13周邊的地面材質、相鄰地貌、邊界標記與回程方向需要清楚呈現，讓隊伍能從北南東西的路徑線索判斷此處是通行、採集、服務、封閉或跨區銜接點。',
